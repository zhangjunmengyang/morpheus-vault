...
- 相关工作：[[AI/Agent/Agentic-RL/Tool-Use-RL-训练专题|Tool-Use-RL-训练专题]] | [[AI/Agent/Agentic-RL/CM2-Checklist-Rewards-Multi-Turn-Tool-Use-RL|CM2-Checklist-Rewards-Multi-Turn-Tool-Use-RL]] | [[AI/Agent/Agentic-RL/PA-MoE-Phase-Aware-Mixture-of-Experts|PA-MoE-Phase-Aware-Mixture-of-Experts]]
...
- [[AI/Agent/Agentic-RL/ARTIST-Agentic-Reasoning-Tool-Integration-RL]] — ARTIST：ASTRA 的轻量替代（无需 tool-graph 工程，GRPO + token masking 直接训多工具）
- [[AI/Agent/Agentic-RL/ToRL-Tool-Integrated-Reinforcement-Learning]] — ToRL：最简洁路线（base model + 单工具，三种行为自然涌现）
