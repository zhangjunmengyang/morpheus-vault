...
rating: "★★★★☆"
tags: [agentic-RL, experiential-learning, reflection, self-distillation, multi-turn, sparse-reward, credit-assignment]
related:
  ...
  - "[[AI/Agent/Agentic-RL/TSR-Trajectory-Search-Rollouts-Multi-Turn-RL|TSR]]"
  - "[[AI/Agent/Agentic-RL/SCoRe-Self-Correction-via-Reinforcement-Learning|SCoRe (ICLR 2025)]]"
  - "[[AI/Agent/Agentic-RL/iStar-Implicit-Step-Rewards-Agentic-RL|iStar]]"
  - "[[AI/Agent/Agentic-RL/Agentic-RL-2026前沿综合分析|Agentic-RL 综合分析]]"
---
...
- [[AI/Agent/Agentic-RL/CSO-Verified-Critical-Step-Optimization|CSO（arXiv:2602.03412）]] — 失败 → 反事实验证（最深，需 expert model）；ERL 是其轻量替代——无需外部 expert，用 LLM 自身反思代替
- [[AI/Agent/Agentic-RL/SELAUR-Self-Evolving-LLM-Agent-Uncertainty-Rewards|SELAUR（arXiv:2602.21158）]] — 失败 → token-level 不确定性 reward（最浅，零成本）；ERL 信号质量更高（反思 Δ 比熵值信息更丰富）；三者共同构成失败信号利用深度谱系

**Multi-Turn RL 四支柱中的位置（ERL = 第四支柱）：**
- [[AI/Agent/Agentic-RL/TSR-Trajectory-Search-Rollouts-Multi-Turn-RL|TSR（ICML 2026）]] — Rollout 质量支柱；与 ERL 正交可叠加（好 rollout + 好反思）
- [[AI/Agent/Agentic-RL/SCoRe-Self-Correction-via-Reinforcement-Learning|SCoRe（NeurIPS 2024）]] — 均衡控制支柱；ERL 是"训练动态修正"，SCoRe 是"架构层修正"

**综述导航：**
- [[AI/Agent/Agentic-RL/Agentic-RL-2026前沿综合分析|Agentic-RL 2026 综合分析]] — ERL 在 Multi-Turn RL 四支柱框架中的定位
