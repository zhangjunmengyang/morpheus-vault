...
- [[AI/Agent/Evaluation/Aletheia-Gemini3-DeepThink-FirstProof|Aletheia FirstProof（arXiv:2602.21201）]] — **有严格数学验证器**的极端案例：TTC scaling（推理计算扩展）比 RL 训练更快达到 frontier——说明当验证器足够可靠时，RL 的独特价值在于**无验证器任务**和**提升 base model 本身**；Weinberger 开放问题首次被 AI 自主解决
