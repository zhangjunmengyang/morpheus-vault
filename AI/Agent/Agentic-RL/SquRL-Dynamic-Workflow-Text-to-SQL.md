...
- [[AI/Agent/Multi-Agent/AgentConductor-Topology-Evolution|AgentConductor]] — topology evolution 的兄弟工作：同为"用 RL 学 agentic 决策"，AgentConductor 做 agent 通信拓扑，SquRL 做工具链选择
