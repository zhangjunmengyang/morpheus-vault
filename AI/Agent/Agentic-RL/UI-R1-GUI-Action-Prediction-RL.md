...
- 对比大系统：[[AI/Agent/Agentic-RL/UI-TARS-2 论文|UI-TARS-2]] — GUI Agent 工程极致路线（Data Flywheel + 异步 multi-turn RL）；UI-R1 可作其冷启动 warm-up
- Reward 设计参考：[[AI/Agent/Agentic-RL/Tool-Use-RL-训练专题|Tool Use RL 训练专题]] — ToolRL reward 粒度分析（坐标级 reward 思路相通）
