...
- **评估体系对应**：[[AI/Agent/Agent评估体系批判-Goodhart法则与Benchmark陷阱|Agent评估体系批判：Goodhart's Law]] — Search-R1 的 7 数据集评估策略体现了"多 benchmark 组合 > 单一指标"原则；两篇互补：训练方法（Search-R1）↔ 评估体系（Goodhart批判）
