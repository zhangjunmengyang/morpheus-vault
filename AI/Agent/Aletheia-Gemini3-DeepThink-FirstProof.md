...
related:
  - "[[AI/Agent/Aletheia-Math-Research-Agent|Aletheia（前作：Erdős 问题，arXiv:2602.10177）]]"
...
**Aletheia 系列（前作 → 续集）**
- [[AI/Agent/Aletheia-Math-Research-Agent|Aletheia 前作（arXiv:2602.10177，Erdős 猜想数据库）]] — 同一 agent 系统的前一阶段：Erdős 4 个开放问题 → FirstProof 6/10 研究级数学题；前作覆盖 Generator-Verifier-Explorer 三组件架构，本文重点在 Best-of-2 策略与自我过滤设计
...
**AI 评估边界（对老板的方法论价值）**
- [[AI/Agent/Agent评估体系批判-Goodhart法则与Benchmark陷阱|Agent 评估体系批判（Goodhart 法则）]] — FirstProof 本身就是对"benchmark 可自动打分"假设的反动：用真实 open problems + 专家人工验证 = 当 agent 能力接近专家水平时，评估本身变成瓶颈；与 Goodhart 分析互证
...
2. [[AI/Agent/Aletheia-Math-Research-Agent|Aletheia 前作]] — 理解 Generator-Verifier 架构完整设计
