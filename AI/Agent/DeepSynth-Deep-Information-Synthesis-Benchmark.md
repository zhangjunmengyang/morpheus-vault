...
tags: [benchmark, agent, information-synthesis, evaluation, web-agent, real-world, agent-evaluation]
sources:
...
3. **[[AI/Agent/Agentic-RL/Agentic-RL-2026前沿综合分析]]** — Reward 设计挑战章节（DeepSynth 提供了新的真实 verifiable reward 来源）
