...
- [[AI/MLLM/DeepSeek-OCR 原理|DeepSeek-OCR 原理]] — 底层原理
- [[AI/MLLM/DeepSeek-VL|DeepSeek-VL]] — 基座模型
- [[AI/MLLM/Qwen 2.5 VL-Unsloth训练|Qwen 2.5 VL Unsloth 训练]] — 同类实践
- [[AI/LLM/Frameworks/Unsloth/训练示例概述|Unsloth 训练示例]] — Unsloth 通用指南
- [[AI/LLM/Frameworks/Unsloth/运行 & 保存模型|Unsloth 运行保存]]
