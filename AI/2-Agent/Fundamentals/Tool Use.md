...
verl 的 agentic RL training 就是解决这个问题的，参见 [[Agentic RL Training|Agentic RL Training]]。
...
- [[记忆模块|记忆模块]] — Agent 的另一核心能力
- [[Agentic RL Training|Agentic RL Training]] — 用 RL 训练 Tool Use
- [[Prompt-Tools|Prompt Engineering Tools]] — 系统 prompt 的工具描述
- [[零碎的点|Multi-Agent 零碎的点]] — 多 Agent 工具协作
