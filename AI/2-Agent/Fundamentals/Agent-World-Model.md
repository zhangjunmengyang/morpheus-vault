...
- [[AI/2-Agent/Agentic-RL/Agentic-RL-2026前沿综合分析|Agentic RL 2026 前沿综合分析]] — World Model 在 Agentic RL 中的角色：环境模型 vs 世界模型
- [[AI/2-Agent/Agentic-RL/KLong-Extremely-Long-Horizon-Agent-RL|KLong]] — 极长 horizon Agent 如何使用内隐 world model
-  — Agent 知识全图谱
- [[AI/3-LLM/RL/Theory/GRPO-改进七维框架分析|GRPO 2026 全景]] — World Model 与 RL 探索策略的关系
