...
LlamaIndex 从 RAG 工具演进为 Agent 框架。核心抽象：**Index → QueryEngine → AgentWorkflow**。v0.11+ 引入 `llama-index-agent` 模块，支持 [[AI/6-应用/RAG/RAG 工程实践|RAG]] 与 Agent 深度融合。
...
- [[AI/6-应用/RAG/RAG 工程实践|RAG 工程实践]] — 检索增强生成
