...
- [[AI/2-Agent/Agentic-RL/Agent-RL-环境工程系统论]] — 环境设计六大原则（与本文互补）
- [[AI/2-Agent/Agentic-RL/GiGPO-Group-in-Group-Policy-Optimization]] — ALFWorld 主战场
- [[AI/2-Agent/Agentic-RL/LOOP-Leave-One-Out-PPO-Long-Horizon-Agent-RL]] — AppWorld 主战场
- [[AI/2-Agent/Agentic-RL/ARTIST-Agentic-Reasoning-Tool-Integration-RL]] — τ-bench 评估
- [[AI/2-Agent/Agentic-RL/EnterpriseGym-Corecraft]] ⭐ — 泛化性研究：真实企业代码库 vs benchmark（本文 benchmark overfitting 论证的实验来源；EnterpriseGym 数据：Agent 迁移到真实场景后性能下降 30-50%）
...
2. **[[AI/2-Agent/Evaluation/DeepSynth-Deep-Information-Synthesis-Benchmark]]** — 多源信息综合新维度，RQ2（提供步骤 +170%）是规划能力瓶颈的直接证据
