...
- [[AI/LLM/Frameworks/verl/Sandbox Fusion 沙箱|Sandbox Fusion 沙箱]] — 代码执行类 reward
- [[AI/LLM/Frameworks/verl/Post-Training 数据准备|Post-Training 数据准备]] — 数据中的 ground truth
- [[AI/LLM/Frameworks/verl/性能调优|性能调优]] — reward 计算的性能
- [[AI/Agent/Agentic-RL/Agentic RL Training|Agentic RL Training]] — Agent 场景的 reward 设计
