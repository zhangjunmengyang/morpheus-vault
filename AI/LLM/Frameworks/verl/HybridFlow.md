...
- [[AI/LLM/Infra/Ray|Ray]] — HybridFlow 的底层编排框架
- [[AI/LLM/Infra/Megatron-LM|Megatron-LM]] — 训练后端之一
- [[AI/LLM/Frameworks/verl/训练后端|训练后端]] — Megatron vs FSDP
- [[AI/LLM/Frameworks/verl/硬件资源预估|硬件资源预估]] — 资源规划
- [[AI/LLM/Frameworks/verl/性能调优|性能调优]] — 训练性能优化
