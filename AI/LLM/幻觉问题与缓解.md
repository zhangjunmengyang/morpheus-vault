---
brief: "LLM 幻觉问题与缓解策略——幻觉的类型（事实性/推理性/上下文性）和产生原因；RAG/RLHF/Chain-of-Verification/Self-Consistency 的缓解方案；生产 LLM 应用中幻觉监控和干预的工程实践。"
title: "LLM 幻觉问题与缓解策略"
date: 2026-02-13
tags:
...
参见 [[AI/LLM/Application/RAG 工程实践|RAG 工程实践]] 中的详细方案。
...
参见 [[AI/LLM/RL/RLHF 全链路|RLHF 全链路]]、[[AI/LLM/RL/DPO/DPO-TRL实践|DPO-TRL实践]] 和 [[AI/LLM/SFT/SFT 原理|SFT 原理]]。
...
- [[AI/LLM/Application/Embedding/Embedding|Embedding]] — 向量嵌入
- [[AI/LLM/Application/Embedding/Embedding 选型|Embedding 选型]] — Embedding 模型选型
- [[AI/LLM/RL/RLHF 全链路|RLHF 全链路]] — RLHF 训练
- [[AI/LLM/SFT/SFT 原理|SFT 原理]] — 有监督微调
- [[AI/LLM/Application/Prompt-Engineering-概述|Prompt-Engineering-概述]] — Prompt 工程基础
- [[AI/Foundations/DL-Basics/Transformer|Transformer]] — Transformer 架构
