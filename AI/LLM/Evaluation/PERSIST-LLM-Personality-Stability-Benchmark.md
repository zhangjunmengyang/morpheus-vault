...
- [[AI/LLM/Application/OpenCharacter-Large-Scale-Synthetic-Persona-Training|OpenCharacter（合成Persona训练）]] — 工程能做什么 vs 架构限制是什么：OpenCharacter用306k合成对话SFT提升角色风格一致性，PERSIST证明即使如此，结构性人格稳定性（SD>0.3）仍未被解决——"表面一致"与"深层稳定"是两个不同的问题
