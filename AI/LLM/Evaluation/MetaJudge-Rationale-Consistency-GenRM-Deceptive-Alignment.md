...
tags: [LLM-evaluation, reward-model, GenRM, rationale-consistency, deceptive-alignment, LLM-as-judge, RLHF]
rating: ★★★★★
status: deprecated
canonical: "[[AI/LLM/RL/Theory/Rationale-Consistency-GenRM-Deceptive-Alignment|Rationale Consistency — 正式版]]"
...
> ⚠️ **DEPRECATED** — 请使用正式完整版：[[AI/LLM/RL/Theory/Rationale-Consistency-GenRM-Deceptive-Alignment|Rationale Consistency（完整版）]]
