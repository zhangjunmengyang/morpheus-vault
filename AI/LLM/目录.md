...
> 前置知识：[[AI/Foundations/目录|数学 + ML + DL 基础]]
...
| [[AI/LLM/Architecture/Qwen3.5-Plus\|Qwen3.5-Plus]] | MoE | 397B-A17B + Linear Attention |
...
- [[AI/LLM/Pretraining/自监督学习与对比学习-2026技术全景|🔥 自监督学习与对比学习 2026 全景]] ⭐ — SimCLR/MoCo/CLIP/MAE/DINO 四大范式全覆盖，含公式推导+面试高频题 ★★★★★
...
### 4.3 强化学习 RL → [[AI/LLM/RL/目录|RL 详细 MOC]]
...
- [[AI/LLM/Inference/SIA-Sparse-Inference-time-Alignment|SIA（ICML 2026，NTU）]] — **稀疏推理时对齐**：只在高熵 Junction 节点干预（20% token = 100% 效果），6x compute 节省；证明 alignment 是 sparse control problem ★★★★☆
...
- [[AI/RAG/RAG-2026-技术全景|🔥 RAG 2026 技术全景]] ⭐ — 面试武器版，Naive→Advanced→Modular→Agentic RAG 全谱系 ★★★★★
- [[AI/RAG/RAG 原理与架构|RAG 原理与架构]]
- [[AI/RAG/Advanced RAG|Advanced RAG]]
- [[AI/RAG 工程实践|RAG 工程实践]]
- [[AI/RAG/RAG vs Fine-tuning|RAG vs Fine-tuning]]
- [[AI/RAG/RAG 评测|RAG 评测]]
- [[AI/RAG/Reranker|Reranker]]
- [[AI/RAG/向量数据库选型|向量数据库选型]]
- [[AI/RAG/文本分块策略|文本分块策略]]
- [[AI/RAG/文档解析|文档解析]]
- [[AI/RAG/检索策略|检索策略]]
...
- [[AI/LLM/Application/OpenCharacter-Large-Scale-Synthetic-Persona-Training|OpenCharacter]] — 合成 Persona 角色扮演训练 ★★★
...
- [[AI/LLM/MA-RLHF-手撕实操-系列索引|🔥 手撕实操总索引]] ⭐ — 全部 25 篇导航 + 三条面试速通路径
...
### 多模态手撕
- [[AI/MLLM/CLIP-ViT-LLaVA-手撕实操|CLIP-ViT-LLaVA-手撕]] — ViT + InfoNCE + LLaVA 投影
...
- [[AI/LLM/MA-RLHF课程/00-课程总览-MOC|🔥 MA-RLHF 课程总览]] — 10 专题 + 4 条面试速通路径 + 课程 vs Vault 关系说明
...
- ↑ 上级：[[AI/目录]]
- ← 前置：[[AI/Foundations/目录]]
## 多模态 RL（MultiModal）
- [[AI/MLLM/Multimodal-Perception-RL-综合分析|🔥 多模态感知 RL 综合分析]] ⭐ — VPPO/Perception-R1/AT-RL/VisRL 四路线全景，统一设计原则 ★★★★★
- [[AI/MLLM/Perception-R1-Visual-Perception-Reward-RLVR|Perception-R1]] — 显式视觉感知 Reward，1,442样本超越200K ★★★★☆

## 相关 MOC
- → 相关：[[AI/MLLM/目录]] · [[AI/Agent/目录]] · [[AI/RAG/_MOC]]
