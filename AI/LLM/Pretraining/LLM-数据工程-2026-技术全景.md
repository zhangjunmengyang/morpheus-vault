---
brief: "LLM 数据工程 2026 技术全景（3778行）——预训练数据采集/清洗/去重/配比/合成全链路；SFT 数据质量工程/对齐数据构建；面试武器库，解释 GPT-4 为何是 GPT-3 数量级但能力质变的标准论证（数据质量革命）。"
...
- [[AI/LLM/Pretraining/LLM预训练与分布式训练2026全景|LLM 预训练 2026 全景]] — 数据工程的下游：如何用好数据训练
- [[AI/Foundations/Training/预训练流程|预训练流程]] — 基础版预训练流程
- [[AI/LLM/Architecture/AI Models Collapse 论文|Model Collapse 论文]] — 数据工程失误（合成数据滥用）的代价
