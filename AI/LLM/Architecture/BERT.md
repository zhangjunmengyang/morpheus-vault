...
### 未解问题与局限
- BERT 的绝对位置编码无法外推到训练长度之外（对比 [[AI/LLM/Architecture/长上下文处理|长上下文处理]] 中的 RoPE）
- MLM 的 15% mask 比例是否最优？SpanBERT 等工作在探索，但没有定论
- Encoder 架构为何难以 scale 到 1T+ 参数？（对比 [[AI/LLM/Architecture/GPT|GPT]] 的 Decoder-Only 路线）

### 脑暴：如果往下延伸
- 如果把 BERT 的双向理解能力和 [[AI/LLM/Architecture/Mamba-SSM|Mamba]] 的线性复杂度结合，能否做出效率更高的 Embedding 模型？
- 结合 [[AI/LLM/Architecture/DeepSeek-R1|DeepSeek-R1]] 的蒸馏经验，1.5B 的 BERT 变体是否能在边缘设备上替代 7B 的 Decoder 模型做理解任务？

## 相关

- [[AI/LLM/Architecture/GPT|GPT]] — Decoder-Only 路线对比，理解两条技术路线的分野
- [[AI/CV/ViT|ViT]] — BERT 思想迁移到视觉领域
- [[AI/MLLM/CLIP|CLIP]] — 多模态对比学习，Encoder 架构的跨模态应用
- [[AI/Foundations/DL-Basics/深度学习|深度学习]]
- [[AI/LLM/SFT/LoRA|LoRA]] — BERT 微调的高效方法
- [[AI/LLM/Architecture/T5|T5]] — Encoder-Decoder 路线的代表
...
- [[AI/LLM/Application/Embedding/Embedding|Embedding]] — BERT 在 RAG 中的核心应用
