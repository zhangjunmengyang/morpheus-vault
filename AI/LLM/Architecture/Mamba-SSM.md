...
- **更好的 [[AI/LLM/Prompt-Engineering-2026实战全景#1.1 In-Context Learning（ICL）：为什么 Prompt 能工作|In-Context Learning]]**：Attention 层保证少样本学习能力
...
3. **Few-shot learning**：[[AI/LLM/Prompt-Engineering-2026实战全景#1.1 In-Context Learning（ICL）：为什么 Prompt 能工作|In-Context Learning]] 能力可能不如 Transformer
...
**答案**：
1. **推理框架支持**：需要支持 selective scan 算子的框架，如 [[AI/LLM/Inference/TensorRT-LLM|TensorRT-LLM]]、vLLM 等
...
### 脑暴：如果往下延伸
- 如果把 Mamba 的状态压缩思想和 [[AI/LLM/Architecture/长上下文处理|长上下文处理]] 中的 Ring Attention 结合，能否实现百万 token 级别的高效分布式推理？
- [[AI/LLM/Architecture/DeepSeek-R1|DeepSeek-R1]] 的推理能力依赖长链 CoT，而 Mamba 擅长长序列——二者结合可能产生"推理效率极高"的新范式

> 🔗 See also: [[AI/LLM/Architecture/架构范式对比|架构范式对比]] — SSM vs Transformer vs MoE 全景对比