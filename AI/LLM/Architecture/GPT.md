...
### 未解问题与局限
- GPT-4 的 MoE 架构细节至今未公开，社区复现（如 [[AI/LLM/Architecture/DeepSeek-R1|DeepSeek-R1]]）在逐步逼近但仍有差距
...
### 脑暴：如果往下延伸
- GPT 的 RLHF 三阶段 vs [[AI/LLM/Architecture/DeepSeek-R1|DeepSeek-R1]] 的纯 RL 路线：哪条路更有前途？R1 证明 RL 可以激发推理，但 GPT 的对齐更全面
- 如果把 [[AI/LLM/Architecture/Mamba-SSM|Mamba]] 的线性复杂度和 GPT 的自回归范式结合，能否突破 Transformer 的长度瓶颈？

## 相关

- [[AI/LLM/Architecture/BERT|BERT]] — Encoder-Only 路线对比，两条技术路线的分野
- [[AI/LLM/Architecture/LLaMA|LLaMA]] — 开源 GPT 路线的代表
- [[AI/LLM/Architecture/T5|T5]] — Encoder-Decoder 路线对比（T5 笔记待建）
- [[AI/LLM/Application/Prompt-Engineering-概述|Prompt engineering 概述]] — ICL 能力的工程化应用
- [[AI/LLM/Infra/分布式训练|分布式训练]] — GPT-3/4 训练所需的基础设施
- [[AI/LLM/Architecture/DeepSeek-R1|DeepSeek-R1]] — 纯 RL 路线对 GPT RLHF 范式的挑战
- [[AI/Foundations/DL-Basics/Transformer 通识|Transformer 通识]]
- [[AI/LLM/Architecture/Attention 变体综述|Attention 详解]]
- [[AI/LLM/RL/PPO/PPO 原理|PPO 原理]] — InstructGPT 使用的 RL 算法
- [[AI/LLM/SFT/SFT 原理|SFT 原理]] — RLHF 三阶段的第一步
