...
### 脑暴：如果往下延伸
- [[AI/LLM/RL/GRPO/GRPO 深度理解|GRPO]] + [[AI/LLM/Architecture/Mamba-SSM|Mamba]] 的组合：SSM 的线性推理效率 + RL 的推理能力激发，能否做出推理效率极高的小模型？
- R1 的蒸馏成功说明 CoT 是可迁移的"知识"。那 Agent 的 ReAct 轨迹能否类似地蒸馏？这对 [[AI/Agent/目录|Agent]] 领域有重大意义
...
- [[AI/LLM/Architecture/GPT|GPT]] — RLHF 路线 vs 纯 RL 路线的对比
- [[AI/Foundations/DL-Basics/MoE 基础|MoE 基础]] — R1 底座的 MoE 架构
