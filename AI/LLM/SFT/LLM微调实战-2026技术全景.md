...
- 详见 [[AI/LLM/RL/Theory/GRPO-Improvement-Panorama-2026|GRPO 改进全景]]
...
- [[Career/AI面试速查手册|AI 面试速查手册]] — 速查层（同系列面试武器）
- [[AI/LLM/RL/RLHF-DPO-2026-技术全景|RLHF DPO 2026 技术全景]] — 本文 RLHF/DPO 章节的深度版（对齐技术完整链路）
- [[AI/LLM/Training/LLM预训练与分布式训练2026全景|LLM 预训练与分布式训练 2026]] — 上游：微调的前提是预训练，两文合读构成训练全链路
- [[AI/LLM/Efficiency/知识蒸馏与模型压缩-2026技术全景|知识蒸馏与模型压缩 2026]] — 下游：微调后的部署优化方向
