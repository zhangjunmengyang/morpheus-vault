...
related:
  ...
  - "[[AI/LLM/Frameworks/TRL/TRL 概述|TRL]]"
  - "[[AI/LLM/SFT/LoRA|LoRA]]"
  - "[[AI/LLM/RL/RLHF-DPO-2026-技术全景|RLHF-DPO 全景]]"
...
>
> 🔗 See also: [[AI/LLM/RL/RLHF-DPO-2026-技术全景|RLHF-DPO 全景]] — SFT 之后的对齐阶段
...
> 🔗 See also: [[AI/LLM/SFT/LoRA|LoRA]] — 参数高效微调，SFT 数据量少时 LoRA 是首选
...
> 🔗 See also: [[AI/LLM/SFT/LoRA|LoRA]] — 参数高效微调的详细原理
...
> 🔗 See also:
> - [[AI/LLM/RL/DPO/DPO-TRL实践|DPO]] — SFT 之后的对齐方法，比 PPO 更简单
> - [[AI/LLM/RL/GRPO/GRPO 深度理解|GRPO]] — DeepSeek 的 RL 方法，SFT 模型是起点
> - [[AI/LLM/RL/PPO/PPO 原理|PPO]] — InstructGPT 使用的经典 RL 算法
> - [[AI/LLM/Frameworks/TRL/TRL 概述|TRL]] — HuggingFace 的训练框架，支持 SFT+DPO+PPO 全流程
