...
![image](assets/GJcad3R4Eoi5WGxMc3Uc09ZxnTg.png)

- Pre-training 本质上也是一种激励，不过是一种弱激励
# 幻觉

![image](assets/RaUPdNrGVov1J7xfLFbc7XUGnXc.png)

- 幻觉怎么解决：用 reward 的方式，如果 unhedged（非含糊其辞，说地信誓旦旦） and wrong，就狠狠惩罚
# R1 训练

![image](assets/ESHWdiucSoS4JCxP9YicMpvjnCO.png)
...
![image](assets/W9r8dcAwHo3y7Qxiebsc2qLEnqd.png)

# GRPO

![image](assets/WNyvdm39LolcXExNZizcJk7qnNb.png)

- R1 和 k1.5 都舍弃了 value function（PPO 的 GAE），都舍弃了过程奖励模型。
# PG

![image](assets/CKrEdLLwBogTDhxIHRCcMoqRnAd.png)

# 开源复现

![image](assets/PrYQdYnkIoirP6xZxKcceHn2nph.png)
...
![image](assets/Ipird4TnxoCKI6x2uSxcPYrOnD4.png)
...
![image](assets/U7Emd4EkIoul0sx6yB2cYLUTn3d.png)
