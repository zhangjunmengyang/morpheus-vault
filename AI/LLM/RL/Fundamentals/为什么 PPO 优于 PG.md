...
- [[AI/LLM/RL/Fundamentals/On-Policy vs Off-Policy|On-Policy vs Off-Policy]] — PPO 的 on-policy 属性
- [[AI/LLM/RL/Fundamentals/HF Deep RL Course|HF Deep RL Course]] — 系统学习 RL
- [[AI/LLM/RL/GRPO/GRPO-verl实践|GRPO-verl实践]] — 去掉 Critic 的 PPO 替代
- [[AI/LLM/RL/DAPO/DAPO-verl实践|DAPO-verl实践]] — DAPO 改进
