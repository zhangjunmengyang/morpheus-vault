...
tags: [code-practice, llm-engineering, ma-rlhf, rl-alignment, reward-model, llama2, bradley-terry, lc8]
related:
...
- [[AI/LLM/RL/PPO/PPO 原理]] — PPO 算法理论（RM 是 RLHF 的前置模块）
- [[AI/LLM/RL/RLHF-DPO-2026-技术全景]] — RLHF 全链路：RM 在四模型体系中的位置
