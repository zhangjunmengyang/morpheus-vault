...
- [[AI/LLM/RL/GRPO/GRPO 深度理解|GRPO 深度理解]] — 基础算法
- [[AI/LLM/RL/GRPO/GRPO-verl实践|GRPO verl 实践]] — 对比参考
...
> - [[AI/Agent/Agentic-RL/Agent-RL-训练实战指南|Agent RL 训练实战指南]] — DAPO clip-higher 在 Agent 场景的完整实践指南，含 entropy collapse 的诊断和修复配方
