...
date: 2026-02-24
type: paper-note
tags: [preference-optimization, alignment, reference-free, sft, one-stage]
rating: ★★★☆☆
sources:
...
related:
  ...
  - "[[AI/LLM/RL/DPO/SimPO-Simple-Preference-Optimization-Reference-Free]]"
  - "[[AI/LLM/RL/Preference-Optimization/IPO-Identity-Preference-Optimization]]"
  - "[[AI/LLM/RL/KTO/KTO-TRL实践]]"
---
...
- **关联笔记**：
  - [[AI/LLM/RL/DPO/DPO-TRL实践|DPO]] — ORPO 试图简化的两阶段方法
  - [[AI/LLM/RL/DPO/SimPO-Simple-Preference-Optimization-Reference-Free|SimPO]] — reference-free 但仍需 SFT
  - [[AI/LLM/RL/Preference-Optimization/IPO-Identity-Preference-Optimization|IPO]] — 理论修正路线
  - [[AI/LLM/RL/KTO/KTO-TRL实践|KTO]] — unpaired preference 路线
  - [[AI/LLM/RL/对齐技术综述|对齐技术综述]] — 全景路线图
