...
related:
  ...
  - "[[AI/LLM/RL/Other-Algorithms/SAPO-Soft-Adaptive-Policy-Optimization|SAPO]]"
updated: 2026-02-24
---
...
- [[AI/LLM/RL/GRPO/GRPO 深度理解|GRPO 深度理解]] — MASPO 是 GRPO 的 drop-in 改进，需先理解 GRPO 基础
- [[AI/LLM/RL/Theory/GRPO-Improvement-Panorama-2026|GRPO 改进全景 2026]] — MASPO 应归入此全景（trust region 改进维度）
- [[AI/LLM/RL/Other-Algorithms/SAPO-Soft-Adaptive-Policy-Optimization|SAPO]] — MASPO 的直接对比基线，同属 soft clipping 方向
- [[AI/Agent/Agentic-RL/SeeUPO-Sequence-Level-Agentic-RL-Convergence-Guarantees|SeeUPO（arXiv:2602.06554）]] — MASPO 改进单轮 GRPO 工程性能；SeeUPO 从理论上证明 multi-turn 场景需要完全不同算法——两者适用场景不重叠
