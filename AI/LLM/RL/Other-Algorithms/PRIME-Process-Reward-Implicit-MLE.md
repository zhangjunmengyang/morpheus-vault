...
aliases: ["PRIME", "Process Reinforcement Implicit Rewards"]
...
date: 2026-02-24
type: paper-note
tags: [rl, process-reward, implicit-prm, credit-assignment, reasoning, math, coding]
rating: ★★★★★
sources:
...
related:
  ...
  - "[[AI/Agent/Agentic-RL/AgentPRM-Process-Reward-Models-for-LLM-Agents]]"
---
...
- 这与 [[AI/LLM/RL/Theory/RL-Signal-Granularity-Causal-Structure-Principle|信号粒度匹配原则]] 完美契合——PRIME 自动将 sparse outcome reward 细化到 token 粒度
...
- **关联笔记**：
  - [[AI/Agent/Agentic-RL/AgentPRM-Process-Reward-Models-for-LLM-Agents|AgentPRM]] — MC rollout 显式 step value
  - [[AI/LLM/RL/GRPO/GRPO 深度理解|GRPO]] — PRIME 的常用 backbone
  - [[AI/LLM/RL/Theory/RL-Signal-Granularity-Causal-Structure-Principle|信号粒度匹配原则]] — PRIME 自动实现信号细化
  - [[AI/LLM/RL/Theory/GRPO-Improvement-Panorama-2026|GRPO 改进全景]] — PRIME 属于 Token 维度改进
  - [[AI/Agent/Agentic-RL/iStar-Implicit-Step-Rewards-Agentic-RL|iStar]] — 另一种 implicit step reward 方案（DPO 视角）
