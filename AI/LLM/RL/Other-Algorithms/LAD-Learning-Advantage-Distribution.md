...
tags: [rl, grpo, advantage-distribution, f-divergence, diversity, policy-optimization, llm-reasoning]
sources:
  - "arXiv:2602.20132 https://arxiv.org/abs/2602.20132"
related:
  - "[[AI/LLM/RL/Theory/GRPO-Improvement-Panorama-2026|GRPO改进全景]]"
...
- [[AI/LLM/RL/Theory/GRPO-Improvement-Panorama-2026|GRPO改进全景]] — LAD 在"目标函数范式"这一支的完整定位
- [[AI/LLM/RL/GRPO/GRPO 深度理解|GRPO深度理解]] — 理解 LAD 改进的是什么

**同期相关工作（互补视角）：**
- [[AI/LLM/RL/Other-Algorithms/OAPL-Off-Policy-RL-LLM-Reasoning|OAPL]] — 正交方向：off-policy regression；LAD 是 on-policy 分布匹配（可组合）
- [[AI/LLM/RL/Other-Algorithms/REBEL-Regret-Based-RL-LLM-Alignment|REBEL]] — 同为"离开期望奖励最大化"的重新建模，regret vs distribution matching
- [[AI/LLM/RL/Other-Algorithms/MASPO-Mass-Adaptive-Soft-Policy-Optimization|MASPO]] — Trust region 方向的改进，与 LAD 正交可叠加
- [[AI/LLM/RL/Other-Algorithms/SAPO-Soft-Adaptive-Policy-Optimization|SAPO]] — **三维正交可叠加**：SAPO 改 clip 函数（sigmoid 软衰减），LAD 改目标函数范式；OAPL+LAD+SAPO 三者覆盖 off-policy/collapse/clip 三个独立问题维度
...
2. **前置**：[[AI/LLM/RL/GRPO/GRPO 深度理解|GRPO深度理解]] — 理解 GRPO 的结构性缺陷才能理解 LAD 的动机
3. **对比**：[[AI/LLM/RL/Other-Algorithms/OAPL-Off-Policy-RL-LLM-Reasoning|OAPL]] — 同期两篇，一个解决 off-policy，一个解决 collapse；组合使用是当前理论上最完整的方案
