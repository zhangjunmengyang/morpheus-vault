...
- [[Jet-RL-FP8-On-Policy-RL-Training]] — 同组后作，FP8 精度 + on-policy 统一，解决量化 off-policy 问题
- [[DEEP-GRPO-Deep-Dense-Exploration-Pivot-Resampling]] — 同样解决 GRPO 探索不足，但从采样策略而非参数噪声角度
- [[MASPO-Mass-Adaptive-Soft-Policy-Optimization]] — 解决 GRPO 正负样本概率质量不平衡，与 QeRL 的探索方向正交
- [[RL-Training-Stability-2026-Unified-Analysis]] — 归属系统效率维度
