...
- [[AI/LLM/RL/Theory/GRPO-Improvement-Panorama-2026|GRPO 改进全景 2026]] — REMuL 在 faithfulness 维度扩展了 GRPO 的优化目标（correctness → correctness + faithfulness）
- [[AI/LLM/RL/Theory/RLRR-Reference-Guided-Alignment-Non-Verifiable|RLRR]] — 同方向：两篇都在解决"RLVR 只优化结果正确性"的局限；RLRR 扩展到 non-verifiable，REMuL 扩展到 faithfulness
- [[AI/Safety/对齐技术总结|对齐技术总结]] — REMuL 是 AI 可解释性与对齐的交叉点，faithful reasoning 是高风险场景对齐的前提
