...
- [[AI/LLM/RL/GRPO/iGRPO|iGRPO]] — 迭代式自反馈 GRPO (arXiv:2602.09000)
...
## 训练框架 (Frameworks)
- [[AI/LLM/Frameworks/Jet-RL-FP8-On-Policy-RL-Training|Jet-RL]] — NVIDIA+MIT HAN Lab：统一 FP8 on-policy RL 训练精度流，解决 BF16-train/FP8-rollout 在长 rollout(>8K) 时精度崩溃和训练发散问题（arXiv:2601.14243）★★★★
- [[AI/LLM/Frameworks/QeRL-Quantization-Enhanced-RL|QeRL]] ⭐ — ICLR 2026（NVIDIA+MIT+HKU+THU+Song Han）：量化噪声是有益的——4-bit 量化+LoRA 的 RL 训练不仅 1.5× 加速，在多项基准上还**超越** 16-bit LoRA；see-also: [[AI/LLM/Frameworks/Jet-RL-FP8-On-Policy-RL-Training|Jet-RL]]（arXiv:2510.11696）★★★★
