...
- **[[AI/Agent/Multi-Agent/IMAGINE-多Agent蒸馏到单模型|IMAGINE]] 式 Agent 蒸馏**：把多 Agent 系统的集体行为蒸馏进单一模型，从"多专家协作"到"一个通才"，可能改变 Agent 系统的部署范式
...
- [[AI/Agent/Multi-Agent/IMAGINE-多Agent蒸馏到单模型|IMAGINE]] — 知识蒸馏的前沿应用：MAS → 单模型行为蒸馏
