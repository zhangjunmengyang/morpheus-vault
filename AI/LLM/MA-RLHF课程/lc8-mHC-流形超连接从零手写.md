...
tags: [code-practice, ma-rlhf, lc8, mhc, hyper-connections, residual, deepseek, architecture]
...
related:
  ...
  - "[[AI/LLM/Architecture/mHC-Manifold-Constrained-Hyper-Connections-DeepSeek]]"
...
- [[AI/LLM/Architecture/mHC-Manifold-Constrained-Hyper-Connections-DeepSeek]] — mHC 论文精读（arXiv:2512.24880），理论背景与实验结果
