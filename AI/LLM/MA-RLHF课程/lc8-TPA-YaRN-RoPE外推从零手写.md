...
tags: [code-practice, ma-rlhf, lc8, tpa, yarn, rope, attention, kv-cache, long-context]
...
- [[AI/LLM/Architecture/Attention 变体综述]] — Attention 变体全谱系，TPA 定位
- [[AI/LLM/Inference/KV Cache|KV Cache]] — KV Cache 压缩全景，TPA/MLA 的工程背景
