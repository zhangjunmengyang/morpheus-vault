---
brief: "文本分块策略——Fixed-size/Sentence/Semantic/Hierarchical 四类分块方法的完整对比；chunk 大小对召回率和精度的影响规律；不同文档类型（代码/学术/对话）的推荐策略。"
...
文本分块（Text Chunking）是 [[AI/RAG/RAG-2026-技术全景|RAG]] 系统中的关键预处理步骤，直接影响检索效果和生成质量。合适的分块策略需要在语义完整性、检索粒度和计算效率之间找到最佳平衡点。不同的文档类型、检索场景和下游任务需要采用不同的分块方法。
...
相关链接：[[AI/RAG/RAG-2026-技术全景|RAG]], [[AI/LLM/Application/RAG/Reranker|Reranker]], [[AI/RAG/Advanced RAG|Advanced RAG]], [[AI/RAG/向量数据库选型|向量数据库]], [[AI/LLM/LLM 评测体系|LLM 评测体系]], [[AI/LLM/Application/RAG/文档解析|文档解析]]