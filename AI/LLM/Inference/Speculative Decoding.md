...
关键是这个过程与 [[AI/LLM/Inference/采样策略|采样策略]] 完全等价，不会改变最终的输出分布。
...
与 [[AI/LLM/Inference/KV Cache|KV Cache]] 配合时需要小心处理分支状态。
...
[[AI/LLM/Inference/推理服务架构|推理服务架构]] 中的 continuous batching 假设所有请求按 token 同步推进，但 speculative decoding 会导致：
...
与 [[AI/LLM/Inference/KV Cache|KV Cache]] 的集成面临：
...
- [[AI/LLM/Inference/KV Cache|KV Cache]] - 缓存机制与内存优化
- [[AI/LLM/Inference/推理服务架构|推理服务架构]] - 生产环境的服务设计
- [[AI/LLM/Inference/采样策略|采样策略]] - 各种解码算法
- [[AI/LLM/Infra/模型并行策略|模型并行策略]] - 大模型分布式推理
- [[AI/LLM/Inference/推理优化|推理优化]] - 其他加速技术