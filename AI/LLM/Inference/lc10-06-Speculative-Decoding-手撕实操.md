...
tags: ["code-practice", "inference", "speculative-decoding", "draft-model", "rejection-sampling"]
related:
  ...
  - "[[AI/LLM/Inference/Sparrow-Video-LLM-Speculative-Decoding|Sparrow-Video-LLM-Speculative-Decoding]]"
...
> **关联**：[[AI/LLM/Inference/Continue-Batching-手撕实操|Continue-Batching-手撕实操]] [[AI/LLM/Inference/vLLM-PageKVCache-手撕实操|vLLM-PageKVCache-手撕实操]] [[AI/LLM/Inference/Sparrow-Video-LLM-Speculative-Decoding|Sparrow-Video-LLM-Speculative-Decoding]]
...
- [[AI/LLM/Inference/Sparrow-Video-LLM-Speculative-Decoding|Sparrow-Video-LLM-Speculative-Decoding]] — 视频 LLM 的推测解码变体
