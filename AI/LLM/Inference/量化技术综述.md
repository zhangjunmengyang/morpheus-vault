...
> 本文为早期草稿版，正式版见 [[AI/LLM/Inference/量化综述]]（结构更完整、标签规范）。保留供参考，不再维护。
...
- [[AI/Foundations/Inference/模型量化综述|模型量化综述]] — Foundations 基础版，与本篇互补
- [[AI/LLM/Inference/端侧推理量化精度陷阱-跨骁龙芯片精度失真|端侧量化精度陷阱]] — 量化实际部署中的精度问题
