...
- [[AI/LLM/Inference/量化综述|量化综述]] — 量化方案综述（PTQ/QAT/GPTQ 等）
- [[AI/LLM/Inference/量化综述]] — 量化综述（另一版本）
- [[AI/LLM/Inference/Jet-RL-FP8-On-Policy-RL-Training|Jet-RL]] — 量化精度不一致问题在 RL 训练侧的体现（FP8 on-policy 精度统一）
