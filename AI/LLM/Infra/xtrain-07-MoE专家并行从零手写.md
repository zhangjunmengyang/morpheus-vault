...
tags: [code-practice, llm-engineering, ma-rlhf, distributed-training, moe, expert-parallel, xtrain]
related:
...
- [[AI/LLM/Architecture/MoE 深度解析]] — MoE 理论全景（gating/负载均衡/capacity factor）
