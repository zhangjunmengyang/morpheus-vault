...
related:
  ...
  - "[[AI/3-LLM/Inference/推理服务架构|模型部署实践]]"
---
...
### 脑暴：如果往下延伸
- 如果把 MCTS 搜索和采样策略结合，可以在推理时做 tree search + 采样的混合——对每个推理步骤做 MCTS 扩展，对最终回复做 nucleus sampling
...
> 🔗 See also: RL 与 RLHF — MCTS + LLM 推理搜索是采样策略的高级形式
> 🔗 See also: [[AI/3-LLM/Inference/Continuous Batching|Continuous Batching]] — 采样策略影响生成长度分布，进而影响 batching 效率
> 🔗 See also: [[AI/3-LLM/Inference/推理服务架构|模型部署实践]] — 采样参数是部署配置的关键部分