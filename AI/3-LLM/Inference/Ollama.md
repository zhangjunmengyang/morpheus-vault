...
- [[Projects/MA-RLHF/lc10/lc10-04-vLLM-V0-手撕实操|vLLM-手撕实操]] — vLLM 核心机制手撕（Continuous Batching / PagedKVCache）
- LLM推理优化2026全景 — 推理优化技术全貌

**量化与模型格式**
- [[AI/3-LLM/Frameworks/Unsloth/量化|量化]] — GGUF 量化技术详解
- [[AI/6-应用/Embedding/Embedding|Embedding]] — Ollama 的 embedding 功能
