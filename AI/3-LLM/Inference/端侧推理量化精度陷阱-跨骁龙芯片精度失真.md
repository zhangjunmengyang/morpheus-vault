...
- [[AI/3-LLM/RL/算法/Jet-RL-FP8-On-Policy-RL-Training|Jet-RL]] — 量化精度不一致问题在 RL 训练侧的体现（FP8 on-policy 精度统一）
...
- [[AI/3-LLM/Inference/量化综述|量化综述]] — 量化技术全貌（INT4/INT8/FP8）
- [[AI/3-LLM/Inference/剪枝与蒸馏|剪枝与蒸馏]] — 端侧压缩的另一路线
- [[AI/3-LLM/Inference/模型部署实践|模型部署实践]] — 端侧部署工程实践（QNN SDK/NPU 调度）