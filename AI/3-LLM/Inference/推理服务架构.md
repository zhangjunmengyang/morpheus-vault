...
class vLLMEngine:
    def __init__(self):
        ...
        self.kv_cache_manager = PagedKVCacheManager()  # [[AI/3-LLM/推理/KV Cache|KV Cache]] PagedAttention
...
- 推理服务架构 — Foundations 精简版（同内容面试速查版）
- LLM 推理优化 2026 全景 — 推理技术全图谱，本篇聚焦服务架构层
- [[AI/3-LLM/Inference/vLLM|vLLM]] — vLLM 源码级深度解析
- [[AI/3-LLM/Inference/KV Cache|KV Cache 优化]] — PagedAttention 原理与内存管理详解
- [[Projects/MA-RLHF/lc10/lc10-07-PD-Disaggregation-手撕实操|PD Disaggregation 手撕实操]] — PD 分离架构代码实现
- [[Projects/MA-RLHF/lc10/lc10-01-Continue-Batching-手撕实操|Continuous Batching 手撕实操]] — 动态批处理代码实现