---
title: "LLM 推理服务架构"
brief: "LLM 推理服务架构深度解析（面试版）：Prefill vs Decode 阶段差异（compute-bound vs memory-bound）、PD 分离架构（解决两阶段资源冲突）、Continuous Batching 原理、KV Cache 管理（PagedAttention）。深度版见 Foundations/Inference/推理服务架构。"
...
> [!info] 另有面试版
> Foundations 精简版：[[AI/1-Foundations/Inference/推理服务架构]]
...
class vLLMEngine:
    def __init__(self):
        ...
        self.kv_cache_manager = PagedKVCacheManager()  # [[AI/3-LLM/Inference/KV Cache|KV Cache]] PagedAttention
...
**特点：**
- PagedAttention：虚拟内存管理 [[AI/3-LLM/Inference/KV Cache|KV Cache]]
...
**特点：**
- TensorRT 编译优化：kernel fusion, [[AI/3-LLM/Inference/量化综述|量化技术综述]] 支持
...
- [[AI/1-Foundations/Inference/推理服务架构]] — Foundations 精简版（同内容面试速查版）
- [[LLM-推理优化-2026-全景|LLM 推理优化 2026 全景]] — 推理技术全图谱，本篇聚焦服务架构层
- [[AI/3-LLM/Inference/vLLM|vLLM]] — vLLM 源码级深度解析
- [[AI/3-LLM/Inference/KV Cache|KV Cache 优化]] — PagedAttention 原理与内存管理详解
- [[AI/3-LLM/Inference/PD-Disaggregation-手撕实操|PD Disaggregation 手撕实操]] — PD 分离架构代码实现
- [[AI/3-LLM/Inference/Continue-Batching-手撕实操|Continuous Batching 手撕实操]] — 动态批处理代码实现