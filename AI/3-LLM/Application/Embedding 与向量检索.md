...
### 脑暴：如果往下延伸
- 结合 [[AI/6-应用/RAG/检索策略|检索策略]] 的 Hybrid Search，BGE-M3 同时输出 Dense+Sparse 是天然的混合检索方案
- Matryoshka Embedding 让"效果-成本"可以连续调节——这对大规模系统意义重大

> 🔗 See also: [[AI/6-应用/RAG/检索策略]] — 检索策略是 Embedding 选型的下游应用
> 🔗 See also: [[RAG-2026-技术全景|RAG 2026 全景]] — Embedding 在完整 RAG 架构中的位置
> 🔗 See also: [[AI/6-应用/RAG/RAG 原理与架构]] — RAG 基础架构
