...
-  — 检索增强生成全景索引
- [[AI/3-LLM/Application/RAG/RAG 检索策略|RAG 检索策略]] — 向量数据库在 RAG 系统中的使用场景
- [[AI/3-LLM/Application/RAG/Advanced RAG|Advanced RAG]] — 向量检索之外的进阶技术
- RAG 2026 技术全景 — 宏观视角
- [[AI/3-LLM/推理/量化综述|模型量化综述]] — embedding 量化以降低存储成本的技术参考
