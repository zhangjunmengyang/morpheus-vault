...
检索是 [[AI/3-LLM/Application/RAG/RAG 原理与架构|RAG]] 系统的核心环节，直接影响最终生成质量。现代检索策略通过多种技术的组合来提升检索精度和召回率。
...
### 脑暴：如果往下延伸
- 结合 RAG 2026 全景 的 Agentic RAG，Agent 可以动态选择检索策略
- [[AI/3-LLM/Application/Embedding/Embedding 与向量检索|Embedding 模型]] 的选型直接决定 Dense Retrieval 的上限

> 🔗 See also: [[AI/3-LLM/Application/Embedding/Embedding 与向量检索]] — Embedding 模型和向量数据库选型
> 🔗 See also: [[AI/3-LLM/Application/RAG/RAG 原理与架构]] — 检索策略在完整 RAG 架构中的位置