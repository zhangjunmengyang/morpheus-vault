...
### 脑暴：如果往下延伸
- 结合 [[RAG-2026-技术全景|RAG]] 的 Codebase 检索是 Cursor/Claude Code 的核心——"知道该看哪个文件"比"写代码"更关键
...
- [[Code-Agent-深度|Code Agent]] — 代码生成 Agent 的产品形态与面试笔记
- [[GitHub-Agentic-Workflows|GitHub Agentic Workflows]] — 代码生成在 CI/CD 的应用
- [[GRPO-Improvement-Panorama-2026|GRPO 2026 全景]] — 代码生成的 RL 训练方法
