...
参见 [[RLHF 全链路|RLHF 全链路]]、[[DPO-TRL实践|DPO-TRL实践]] 和 [[SFT 原理|SFT 原理]]。
...
- [[Embedding 选型|Embedding 选型]] — Embedding 模型选型
- [[RLHF 全链路|RLHF 全链路]] — RLHF 训练
- [[SFT 原理|SFT 原理]] — 有监督微调
- [[Prompt-Engineering-概述|Prompt-Engineering-概述]] — Prompt 工程基础
