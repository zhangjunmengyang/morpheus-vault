...
- [[AI/3-LLM/Frameworks/verl/verl 概述|verl 概述]] — verl 框架总览（组件/训练流程/设计哲学）
- [[AI/3-LLM/Frameworks/verl/训练后端|训练后端]] — 工程落地：rollout、并行、吞吐与稳定性
- [[AI/3-LLM/RL/算法/GRPO 深度理解|GRPO 深度理解]] — GRPO 算法深度解析与边界条件（multi-turn 注意 SeeUPO）
- [[AI/3-LLM/RL/算法/PPO 原理|PPO 原理]] — PPO/GAE 的理论与实现细节
- [[AI/3-LLM/RL/实践/DAPO-verl实践|DAPO-verl实践]] — verl 中 DAPO 的配置与踩坑
- [[AI/3-LLM/RL/实践/GRPO-verl实践|GRPO-verl实践]] — verl 中 GRPO 的端到端实践
- [[AI/3-LLM/RL/实践/PPO-verl实践|PPO-verl实践]] — verl PPO 训练实践（dense reward 场景）
- [[AI/3-LLM/RL/实践/DPO-TRL实践|DPO-TRL实践]] — TRL 体系下的 DPO 实操（与 verl 做对照）
- [[AI/4-模型/DeepSeek/DeepSeek-R1|DeepSeek-R1]] — GRPO 的大规模应用案例
- [[AI/3-LLM/RL/算法/DeepSeek-Math|DeepSeek-Math]] — GRPO 起源与可验证任务范式
