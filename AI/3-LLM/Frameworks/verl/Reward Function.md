...
- [[Sandbox Fusion 沙箱|Sandbox Fusion 沙箱]] — 代码执行类 reward
- [[Post-Training 数据准备|Post-Training 数据准备]] — 数据中的 ground truth
- [[性能调优|性能调优]] — reward 计算的性能
- [[Agentic RL Training|Agentic RL Training]] — Agent 场景的 reward 设计
