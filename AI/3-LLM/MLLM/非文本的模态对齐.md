---
brief: "非文本模态对齐——图像/音频/视频与语言的跨模态对齐方法论；CLIP 对比学习/Q-Former 桥接/视觉指令微调的技术路线；理解为什么 VLM 能理解图像而不只是描述图像的机制分析。"
title: "非文本的模态对齐"
type: concept
domain: ai/mllm
created: "2026-02-13"
...
![image](U6epdhVcAoC4m1xjdkDcgAeunVc.png)

![image](HrDTdLwV9opLf7xMMR7cmJFunjk.png)
...
-  — 多模态大模型全景索引
- [[AI/3-LLM/MLLM/CLIP|CLIP]] — 视觉-文本对比学习的基石方法
- [[多模态大模型-2026-技术全景|多模态大模型 2026 全景]] — 宏观视角下的模态对齐技术演进
- [[AI/3-LLM/MLLM/Seed1.5-VL|Seed1.5-VL]] — 另一个尝试超越文本监督的多模态方案
- [[AI/3-LLM/Architecture/Attention变体综述|Attention 变体综述]] — 跨模态注意力机制的基础
