---
brief: "玩玩多模态大模型——VLM 上手实践笔记；API 调用/图像输入格式/多轮对话/视频处理的快速入门；记录在实际使用 GPT-4V/Qwen-VL/InternVL 中发现的有趣能力和局限性。"
title: "玩玩多模态大模型"
type: concept
domain: ai/mllm
created: "2026-02-13"
...
- [[InternVL3|InternVL3]] — InternVL 系列
- [[Qwen 2.5 VL-Unsloth训练|Qwen 2.5 VL 训练]] — Qwen VLM 微调
- [[DeepSeek-OCR 原理|DeepSeek-OCR]] — OCR 专项
- [[Seed1.5-VL|Seed1.5-VL]] — 字节方案
