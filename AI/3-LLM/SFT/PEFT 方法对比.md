...
- LLM微调实战2026全景 ⭐ — PEFT方法的工程落地指南；哪个场景用LoRA、QLoRA、DoRA，本文理论 + 微调实战提供实践配方
...
- [[AI/3-LLM/SFT/Post-Training-Unified-View|Post-Training 统一视角]] — PEFT是post-training工程的核心工具；统一视角论文提供了SFT/RLHF/DPO在PEFT框架下的系统性理解
