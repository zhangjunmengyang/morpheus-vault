...
- [[LoRA|LoRA（低秩适应）]] — PEFT家族核心成员，本文对比的基准方法；LoRA的rank选择直接决定参数效率与表达能力的折中
- [[EWC-LoRA-Continual-Learning-Low-Rank|EWC-LoRA（持续学习LoRA）]] — LoRA在持续学习场景的扩展：Fisher information正则化克服灾难性遗忘，是PEFT方法在multi-task场景下的前沿演化方向
...
- [[Post-Training Unified View 论文|Post-Training 统一视角]] — PEFT是post-training工程的核心工具；统一视角论文提供了SFT/RLHF/DPO在PEFT框架下的系统性理解
