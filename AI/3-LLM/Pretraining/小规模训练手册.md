...
- [[AI/3-LLM/Pretraining/Karpathy-nanochat|Karpathy nanochat]] — 小规模实验参考：从零实现 chat 模型的代码路径
- [[AI/3-LLM/Pretraining/LLM预训练与分布式训练2026技术全景|LLM预训练全景]] — 大规模延伸：小规模摸通原理后的工程扩展
