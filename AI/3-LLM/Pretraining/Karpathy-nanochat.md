...
- [[AI/3-LLM/Pretraining/预训练原理|LLM 预训练 2026 全景]] — nanochat 实验与工业级预训练的对比
- [[AI/3-LLM/Pretraining/预训练原理|预训练流程]] — 预训练的基础概念
- [[AI/3-LLM/Frameworks/verl/verl 概述|verl 框架]] — 对照：verl 是工业级 RL 训练框架
-  — 大语言模型知识全图谱
