...
### 多领域数据混合
基于 [[AI/3-LLM/Pretraining/预训练原理#Scaling Laws|Scaling Laws]] 的最优配比：
...
相关笔记：[[AI/3-LLM/Architecture/FlashAttention|Transformer Architecture]]、[[AI/3-LLM/SFT/训练数据构建|SFT 训练流程]]、[[AI/3-LLM/Infra/模型并行策略]]、[[AI/3-LLM/RL/算法/GRPO 深度理解|RLHF/GRPO]]、[[AI/3-LLM/Pretraining/预训练数据工程|预训练数据工程]] — 本文讲原理，数据工程讲 Dedup/过滤/配比工程实现
## See Also

- [[AI/3-LLM/Pretraining/LLM预训练与分布式训练2026技术全景|LLM预训练全景]] — 本文原理的工程完整实现：数据并行/流水线/张量并行 + ZeRO 全景
- [[AI/3-LLM/Pretraining/LLM数据工程2026技术全景|LLM数据工程全景]] — 预训练数据侧：Dedup/质量过滤/DoReMi/合成数据飞轮
- [[AI/3-LLM/Pretraining/Karpathy-nanochat|Karpathy nanochat]] — 最小可运行版本：从零实现 SFT chat 模型，验证原理
