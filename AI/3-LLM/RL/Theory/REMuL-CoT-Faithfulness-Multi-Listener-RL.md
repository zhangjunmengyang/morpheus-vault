...
- [[AI/3-LLM/RL/算法/ProGRPO-Probabilistic-Advantage-Reweighting|ProGRPO]] — 同为 GRPO 改进；ProGRPO 改 advantage 结构，REMuL 改优化目标本身
...
- [[AI/3-LLM/RL/算法/RICOL-Retrospective-In-Context-Online-Learning|RICOL]] — 方法论互补：REMuL 用多监听者 faithfulness 作为 RL reward（优化过程质量），RICOL 用 ICL 前后 log-prob 差作为 advantage（免 critic credit assignment）——两者都在挖掘 LLM 内部能力作为训练信号
