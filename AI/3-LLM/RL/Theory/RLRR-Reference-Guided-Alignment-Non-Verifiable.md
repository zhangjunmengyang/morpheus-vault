...
status: permanent
see-also:
  - "[[AI/3-LLM/RL/算法/ProGRPO-Probabilistic-Advantage-Reweighting|ProGRPO]]"
...
- [[AI/3-LLM/RL/实践/RLHF-工程全栈|RLHF 全链路]] — RLVR 的传统对齐路线（RLRR 是其 non-verifiable 扩展）
- [[AI/5-AI 安全/对齐技术总结|对齐技术总结]] — RLHF/DPO/Constitutional AI 对齐方法全景
- AI 安全与对齐 2026 全景 — Scalable Oversight 等与 RLRR 问题动机相关
- [[AI/3-LLM/RL/Theory/GRPO-改进七维框架分析|GRPO 改进全景 2026]] — RLVR 在 verifiable 域的改进全景（与 RLRR non-verifiable 互补）
- [[AI/3-LLM/RL/算法/ProGRPO-Probabilistic-Advantage-Reweighting|ProGRPO]] — RLVR 信号质量改进；RLRR 解决的是 RLVR 能力边界（无 verifier 场景）
