...
- [[AI/3-LLM/RL/算法/PACED-RL-Partition-Function-Difficulty-Scheduler|PACED-RL]] — GFlowNet + difficulty scheduler；本文的 log-prob reward 与 partition function 有数学联系（JEPO 的 log-mean-exp 结构与 GFlowNet 目标函数同构）
