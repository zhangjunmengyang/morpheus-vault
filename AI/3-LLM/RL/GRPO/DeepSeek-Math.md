...
- [[AI/3-LLM/RL/GRPO/GRPO 深度理解|GRPO 深度理解]] — GRPO 算法的深入分析
- [[AI/3-LLM/Architecture/DeepSeek-R1|DeepSeek-R1]] — GRPO 的大规模应用
- [[AI/3-LLM/RL/PPO/PPO 原理|PPO 原理]] — GRPO 的对比基线
...
- [[AI/3-LLM/RL/GRPO/GRPO-TRL实践|GRPO-TRL实践]] — TRL 中的 GRPO 实现
- [[AI/3-LLM/RL/GRPO/GRPO-verl实践|GRPO-verl实践]] — verl 中的 GRPO 实现
