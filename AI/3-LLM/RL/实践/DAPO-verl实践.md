...
- [[AI/3-LLM/RL/算法/GRPO 深度理解|GRPO 深度理解]] — 基础算法
- [[AI/3-LLM/RL/实践/GRPO-verl实践|GRPO verl 实践]] — 对比参考
...
> - [[AI/2-Agent/Agentic-RL/KLong-Extremely-Long-Horizon-Agent-RL|KLong（极长 horizon Agent）]] — 极长任务场景下 DAPO 思路的延伸：如何在 100+ step 的训练中维持探索熵
