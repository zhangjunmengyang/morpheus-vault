...
![image](Y5DxdetpfonVl5xzXoMcaBbfn2b.png)

训练现象二：可以看到，随着模型学习，奖励函数的奖励值逐渐接近 0。这是一个好迹象，表明模型正在学习生成正确长度的文本。

![image](WRHzdBrDCo78YVxzwZ8cXE8Snbb.png)

---

## See Also

- [[AI/3-LLM/RL/算法/GRPO 深度理解|GRPO 深度理解]] — 算法原理，实现的数学基础
- [[AI/3-LLM/RL/实践/GRPO-demo|GRPO Demo]] — Demo 实践，与本篇互补
