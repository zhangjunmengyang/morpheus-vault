...
- [[AI/3-LLM/RL/实践/DPO-Unsloth实践|DPO Unsloth 实践]] — SPIN 的 loss 基于 DPO
- [[AI/3-LLM/RL/实践/SPPO-verl实践|SPPO verl 实践]] — 类似的自我对弈思路
- [[AI/3-LLM/RL/实践/GRPO-verl实践|GRPO verl 实践]] — on-policy RL 方案
