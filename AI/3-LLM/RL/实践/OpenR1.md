...
- [[AI/4-模型/DeepSeek/DeepSeek-R1|DeepSeek-R1]] — 被复现的原始论文
- [[AI/3-LLM/RL/算法/GRPO 深度理解|GRPO 深度理解]] — GRPO 算法详解
- [[AI/3-LLM/RL/算法/DeepSeek-Math|DeepSeek-Math]] — GRPO 的起源
- [[AI/3-LLM/Frameworks/TRL/TRL 概述|TRL 概述]] — OpenR1 依赖的训练框架
- [[AI/3-LLM/RL/实践/GRPO-TRL实践|GRPO-TRL实践]] — TRL 中 GRPO 的实践
