...
venue: preprint (2024)
related:
  - "[[AI/3-LLM/RL/实践/DPO-TRL实践]]"
  - "[[AI/3-LLM/RL/算法/SimPO-Simple-Preference-Optimization-Reference-Free]]"
  - "[[AI/3-LLM/RL/算法/IPO-Identity-Preference-Optimization]]"
  - "[[AI/3-LLM/RL/实践/KTO-TRL实践]]"
---
...
- **关联笔记**：
  - [[AI/3-LLM/RL/实践/DPO-TRL实践|DPO]] — ORPO 试图简化的两阶段方法
  - [[AI/3-LLM/RL/算法/SimPO-Simple-Preference-Optimization-Reference-Free|SimPO]] — reference-free 但仍需 SFT
  - [[AI/3-LLM/RL/算法/IPO-Identity-Preference-Optimization|IPO]] — 理论修正路线
  - [[AI/3-LLM/RL/实践/KTO-TRL实践|KTO]] — unpaired preference 路线
  - [[AI/3-LLM/RL/实践/对齐技术综述|对齐技术综述]] — 全景路线图
