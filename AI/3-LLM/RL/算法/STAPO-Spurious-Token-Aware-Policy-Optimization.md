...
- 相关：[[AI/3-LLM/RL/算法/GRPO 深度理解|GRPO]]、[[AI/3-LLM/RL/实践/DAPO-verl实践|DAPO]]、[[AI/3-LLM/RL/算法/Blockwise-Advantage-Estimation|Blockwise-Advantage-Estimation]]（同样是 credit assignment 问题）
- 对比：[[AI/3-LLM/RL/算法/LACONIC-Length-Constrained-RL|LACONIC-Length-Constrained-RL]]（也是 token 级别干预）
- 框架：在 [[AI/3-LLM/RL/算法/Slime-RL-Framework|Slime-RL-Framework]] 的 async 设置下，S2T mask 计算开销接近零
- 同族：[[AI/3-LLM/RL/算法/Stable-Asynchrony-VCPO-Off-Policy-RL|Stable-Asynchrony-VCPO-Off-Policy-RL]]（系统级稳定，与 STAPO token 级正交）、[[AI/3-LLM/RL/算法/Goldilocks-RL-Task-Difficulty-Curriculum|Goldilocks-RL-Task-Difficulty-Curriculum]]（样本级稳定）
