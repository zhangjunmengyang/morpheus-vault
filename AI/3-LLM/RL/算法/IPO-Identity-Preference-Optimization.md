...
related:
  ...
  - "[[AI/3-LLM/RL/算法/REBEL-Regret-Based-RL-LLM-Alignment]]"
---
...
- **关联笔记**：
  - [[AI/3-LLM/RL/实践/DPO-TRL实践|DPO]] — IPO 试图修正的对象
  - [[AI/3-LLM/RL/算法/SimPO-Simple-Preference-Optimization-Reference-Free|SimPO]] — 继承 IPO "绕过 BT" 精神的实用算法
  - [[AI/3-LLM/RL/算法/REBEL-Regret-Based-RL-LLM-Alignment|REBEL]] — 另一种绕过 BT 假设的 regression 方案
  - RLHF/DPO 2026 技术全景 — 完整对齐技术路线图
