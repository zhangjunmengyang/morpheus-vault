---
title: "ExpLang: 多语言思维提升 LLM 推理的 RL 训练"
brief: "ExpLang（arXiv:2602.21887，ICML 2026）：用多语言「思维语言」提升 RLVR 探索多样性。关键发现：英文思维不是最优解——不同语言有不同推理优势，多语言混合思维提升 test-time scaling 效果。"
arxiv: "2602.21887"
date: 2026-02-27
venue: ICML 2026（投稿）
rating: ★★★☆☆
tags:
  ...
  - ICML2026
sources:
  - "arXiv:2602.21887 (2026-02-26)"
  - "GitHub: https://github.com/RiverGao/ExpLang"
related:
  - "[[AI/3-LLM/RL/Theory/GRPO-改进七维框架分析]]"
  - "[[AI/3-LLM/RL/算法/DEEP-GRPO-Deep-Dense-Exploration-Pivot-Resampling]]"
---
...
- [[AI/3-LLM/RL/Theory/GRPO-改进七维框架分析|GRPO 改进全景]] — ExpLang 与 GRPO 正交可叠加（扩展探索空间 vs 优化 advantage 估计）
- [[AI/3-LLM/RL/算法/DEEP-GRPO-Deep-Dense-Exploration-Pivot-Resampling|DEEP-GRPO]] — 同为探索增强方向：DEEP-GRPO 靠难样本重采样，ExpLang 靠语言多样性；对比两种探索扩展路径
- [[AI/3-LLM/RL/算法/Goldilocks-RL-Task-Difficulty-Curriculum|Goldilocks RL]] — 课程学习视角：Goldilocks 控制任务难度多样性，ExpLang 控制推理路径多样性，正交互补
