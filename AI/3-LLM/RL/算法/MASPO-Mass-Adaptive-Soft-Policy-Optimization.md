...
related:
  ...
  - "[[AI/3-LLM/RL/算法/SAPO-Soft-Adaptive-Policy-Optimization|SAPO]]"
updated: 2026-02-24
---
...
- [[AI/3-LLM/RL/算法/GRPO 深度理解|GRPO 深度理解]] — MASPO 是 GRPO 的 drop-in 改进，需先理解 GRPO 基础
- [[AI/3-LLM/RL/Theory/GRPO-改进七维框架分析|GRPO 改进全景 2026]] — MASPO 应归入此全景（trust region 改进维度）
- [[AI/3-LLM/RL/算法/SAPO-Soft-Adaptive-Policy-Optimization|SAPO]] — MASPO 的直接对比基线，同属 soft clipping 方向
