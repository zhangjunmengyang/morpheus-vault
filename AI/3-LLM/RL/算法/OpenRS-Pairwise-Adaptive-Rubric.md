...
- [[AI/3-LLM/RL/算法/RLTF-RL-from-Text-Feedback|RLTF-RL-from-Text-Feedback]] — text feedback 内化路线
- [[AI/3-LLM/RL/实践/RARL-Reward-Modeling-Survey|RARL-Reward-Modeling-Survey]] — reward modeling 综述背景
