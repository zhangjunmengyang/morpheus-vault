...
- **关联笔记**：
  - [[AI/3-LLM/RL/算法/PPO 原理|PPO]] — REBEL 试图简化的对象
  - [[AI/3-LLM/RL/算法/GRPO 深度理解|GRPO]] — 另一种 critic-free 简化
  - [[AI/3-LLM/RL/实践/DPO-TRL实践|DPO]] — 理论近亲（BT 假设下等价）
  - [[AI/3-LLM/RL/算法/IPO-Identity-Preference-Optimization|IPO]] — 同一问题的另一种解法
