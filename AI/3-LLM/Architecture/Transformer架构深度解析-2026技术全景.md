...
related:
  ...
  - "[[AI面试速查手册|AI 面试速查手册]]"
  - "[[LLM微调实战-2026技术全景|LLM 微调实战 2026]]"
---
...
- **[[AI-Agent-2026-技术全景|Agent]] 对架构的反向需求**：Agent 需要超长 context（episodic memory）+ 快速推理（多步决策）+ 低成本（高频调用）。这三个需求同时推动 SSM 混合架构、Speculative Decoding 和 MoE 的发展。
...
> 🔗 See also: [[MoE 深度解析|MoE 深度解析]] — MoE 架构的专题深入（负载均衡、Expert Parallelism 细节）
> 🔗 See also: [[AI-Agent-2026-技术全景|AI Agent 2026 全景]] — Agent 如何依赖和推动 Transformer 架构演进
> 🔗 See also: [[LLM-推理优化-2026-全景|LLM 推理优化]] — 推理加速的工程全景（与本文架构视角互补）
