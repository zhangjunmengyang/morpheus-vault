...
related:
  ...
  - "[[AI/3-LLM/Architecture/长上下文技术|长上下文处理]]"
...
- **更好的 Prompt-Engineering-2026实战全景**：Attention 层保证少样本学习能力
...
3. **Few-shot learning**：Prompt-Engineering-2026实战全景 能力可能不如 Transformer
...
### 脑暴：如果往下延伸
- 如果把 Mamba 的状态压缩思想和 [[AI/3-LLM/Architecture/长上下文技术|长上下文处理]] 中的 Ring Attention 结合，能否实现百万 token 级别的高效分布式推理？
- [[AI/4-模型/DeepSeek/DeepSeek-R1|DeepSeek-R1]] 的推理能力依赖长链 CoT，而 Mamba 擅长长序列——二者结合可能产生"推理效率极高"的新范式
