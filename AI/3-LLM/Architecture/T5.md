...
- [[Transformer|Transformer]] — T5 的基础架构
- [[Transformer 通识|Transformer 通识]] — Transformer 家族概览
- [[AI/3-LLM/Architecture/BERT|BERT]] — Encoder-only 对比
- [[AI/3-LLM/Architecture/GPT|GPT]] — Decoder-only 对比
- [[AI/3-LLM/Architecture/Attention 变体综述|Attention 详解]] — 注意力机制细节
- [[Transformer 位置编码详解|Transformer 位置编码详解]] — T5 的相对位置编码
