...
- → [[AI/3-LLM/Inference/Test-Time-Compute|Test-Time-Compute]] (looping 是 latent TTC 的一种)
- → [[AI/3-LLM/Inference/Deep-Thinking-Ratio-DTR|Deep-Thinking-Ratio-DTR]] (late layer indispensability 共同主题)
