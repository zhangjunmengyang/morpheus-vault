...
### 脑暴：如果往下延伸
- 如果把 BERT 的双向理解能力和 [[Mamba-SSM|Mamba]] 的线性复杂度结合，能否做出效率更高的 Embedding 模型？
- 结合 [[DeepSeek-R1|DeepSeek-R1]] 的蒸馏经验，1.5B 的 BERT 变体是否能在边缘设备上替代 7B 的 Decoder 模型做理解任务？

## 相关

- [[GPT|GPT]] — Decoder-Only 路线对比，理解两条技术路线的分野
- [[AI/CV/ViT|ViT]] — BERT 思想迁移到视觉领域
- [[CLIP|CLIP]] — 多模态对比学习，Encoder 架构的跨模态应用
- [[深度学习|深度学习]]
- [[LoRA|LoRA]] — BERT 微调的高效方法
- [[T5|T5]] — Encoder-Decoder 路线的代表
- [[LLaMA|LLaMA]]
