...
- 结合 [[AI/3-LLM/Architecture/DeepSeek-R1|DeepSeek-R1]] 的蒸馏经验，1.5B 的 BERT 变体是否能在边缘设备上替代 7B 的 Decoder 模型做理解任务？
...
- [[AI/3-LLM/Application/Embedding/Embedding|Embedding]] — BERT 在 RAG 中的核心应用
