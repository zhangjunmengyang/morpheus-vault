...
**相关笔记**：[[AI/3-LLM/Architecture/Transformer 位置编码|Transformer 位置编码]] | [[AI/3-LLM/Architecture/BERT|BERT]] | [[GPT|GPT]] | [[LLaMA|LLaMA]] | [[AI/3-LLM/Architecture/Tokenizer-Embedding-手撕实操|Tokenizer-Embedding-手撕实操]] — 手写 BPE 合并 + token embedding lookup 完整实现
