...
- **但 Encoder 架构没死**：[[AI/4-模型/Google/BERT|BERT]] 在 Embedding/Reranker/NER 等场景仍不可替代，不要因为"GPT 赢了"就忽视 Encoder 架构
...
- [[AI/4-模型/Google/BERT|BERT]] — Encoder-Only 路线的代表，MLM 预训练奠基
