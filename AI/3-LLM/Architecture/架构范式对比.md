...
- 如果 Encoder-Decoder 在小模型场景下更高效，那 [[AI/3-LLM/Architecture/Qwen|Qwen]] 等开源模型是否应该为 Edge 场景提供 Encoder-Decoder 版本？

---

## See Also

- [[AI/3-LLM/Architecture/GPT|GPT]] — Decoder-Only 路线的代表，GPT-2/3 确立自回归生成范式
...
- [[Transformer架构深度解析-2026技术全景]] — Transformer 完整架构全景图
