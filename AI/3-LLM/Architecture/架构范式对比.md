...
### 脑暴：如果往下延伸
- MoE + Decoder-Only（[[AI/4-模型/DeepSeek/DeepSeek-R1|DeepSeek-R1]]）vs SSM + Attention 混合（Jamba）：下一个十年的架构竞争会是什么格局？
...
- [[AI/4-模型/Google/T5|T5]] — Encoder-Decoder 路线的代表，"一切任务皆 seq2seq"
