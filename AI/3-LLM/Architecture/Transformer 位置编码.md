...
Su et al., 2021 提出，现已成为 **LLM 主流位置编码方案**（[[AI/4-模型/Meta/LLaMA|LLaMA]]、Qwen、[[AI/4-模型/DeepSeek/DeepSeek-R1|DeepSeek]]、Mistral 均采用）。
...
- [[AI/4-模型/Meta/LLaMA|LLaMA]] — RoPE 的最重要工业应用，LLaMA 系列推动了 RoPE 成为事实标准
