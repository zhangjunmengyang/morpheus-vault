...
参见 [[AI/6-应用/Embedding/Embedding 选型|Embedding 选型]] 了解基础内容。
...
- [[AI/6-应用/Embedding/Embedding|Embedding]] — 向量化基础
- [[AI/6-应用/Embedding/Embedding 选型|Embedding 选型]] — 详细选型对比
- [[AI/3-LLM/Inference/vLLM|vLLM]] — RAG 的 LLM 推理后端
- [[AI/6-应用/Prompt/Prompt-Engineering-基础|Prompt Engineering]] — RAG prompt 设计
