...
[[RAG-2026-技术全景|RAG]] 系统评测是确保生产质量的关键环节。与传统 NLP 任务不同，RAG 涉及检索和生成两个阶段，需要多维度、端到端的评估体系。
...
相关笔记：[[AI/6-应用/RAG/RAG 原理与架构|RAG 系统架构设计]] | [[AI/3-LLM/Application/RAG/向量数据库选型|向量数据库选型]] | [[AI/3-LLM/Evaluation/LLM 评测体系|LLM 评测体系]]