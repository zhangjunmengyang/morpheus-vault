---
title: 对齐技术总结：从RLHF到Constitutional AI
brief: 系统梳理AI对齐技术路线：RLHF三阶段流程与局限性、Constitutional AI自我监督方法、DPO及其变体(IPO/SimPO)的简化对齐、红队测试与越狱防御、Scalable Oversight与Weak-to-Strong泛化。核心洞察：DPO通过跳过RM训练降低复杂度，但数据质量决定上限；Constitutional AI用明文原则替代人工标注实现可审计对齐。
tags:
  - AI-Safety
  - Alignment
  - RLHF
...
dikw: K
sources:
  - InstructGPT (RLHF) — Ouyang et al. arXiv:2203.02155
  - Constitutional AI — Bai et al. arXiv:2212.08073
  - DPO — Rafailov et al. arXiv:2305.18290
  - RLAIF — Lee et al. arXiv:2309.00267
  - Reward Hacking 综述 — Skalse et al. arXiv:2201.03544
  - Deceptive Alignment — Hubinger et al. arXiv:1906.01820
  - Weak-to-Strong Generalization — Burns et al. arXiv:2312.09390
  - Scalable Oversight (Debate) — Irving et al. arXiv:1810.08100
related:
  - "[[AI安全与对齐-2026技术全景|AI安全与对齐 2026 全景]]"
...
[[RLHF-DPO-2026-技术全景|强化学习人类反馈]]（Reinforcement Learning from Human Feedback, RLHF）是当前最成功的对齐技术：
...
### 脑暴：如果往下延伸
- 将 DPO 的偏好数据与 [[AI/3-LLM/Application/幻觉问题|幻觉检测]] 的 SelfCheckGPT 结合：自动生成 (无幻觉回答, 含幻觉回答) 偏好对 → 无需人工标注的 anti-hallucination DPO
- Constitutional AI + [[AI安全与对齐-2026技术全景|可解释性]] 中的 SAE 特征：用 SAE 验证模型是否真正遵循宪法原则（特征级证据，而非行为级推断）
...
flowchart LR
    subgraph 对齐技术演进
        ...
        C --> E[RLAIF 规模化<br/>2024]
        D --> F[DPO + RepE 组合<br/>2025-2026]
        E --> F
    end
    subgraph 验证方法
        G[行为测试] --> H[SAE 特征检测]
...
- [[AI/3-LLM/RL/RLHF-工程全栈|RLHF 全链路]] — RLHF 完整流程（SFT + RM + PPO）
- [[AI安全与对齐-2026技术全景|AI 安全与对齐 2026 技术全景]] — 大全景版，覆盖红队/鲁棒性/Scalable Oversight
-  — GRPO/DPO/PPO 等所有对齐算法
- [[AI/3-LLM/SFT/_MOC|SFT MOC]] — 监督微调路径
- [[AI/5-AI 安全/EVMbench-AI-Agent-Smart-Contract-Exploit|EVMbench]] — AI Agent 安全实战案例
- [[AI/5-AI 安全/Clinejection-AI-Coding-Agent-Supply-Chain-Attack|Clinejection]] — AI Coding Agent 供应链攻击