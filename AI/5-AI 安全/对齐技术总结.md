...
### 脑暴：如果往下延伸
- 将 DPO 的偏好数据与 [[幻觉问题|幻觉检测]] 的 SelfCheckGPT 结合：自动生成 (无幻觉回答, 含幻觉回答) 偏好对 → 无需人工标注的 anti-hallucination DPO
...
- [[RLHF 全链路|RLHF 全链路]] — RLHF 完整流程（SFT + RM + PPO）
- [[AI安全与对齐-2026技术全景|AI 安全与对齐 2026 技术全景]] — 大全景版，覆盖红队/鲁棒性/Scalable Oversight
- [[AI/3-LLM/RL/目录|RL 总 MOC]] — GRPO/DPO/PPO 等所有对齐算法
- [[AI/3-LLM/SFT/_MOC|SFT MOC]] — 监督微调路径
- [[EVMbench-AI-Agent-Smart-Contract-Exploit|EVMbench]] — AI Agent 安全实战案例
- [[Clinejection-AI-Coding-Agent-Supply-Chain-Attack|Clinejection]] — AI Coding Agent 供应链攻击