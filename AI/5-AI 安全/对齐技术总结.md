...
- Constitutional AI + 可解释性 中的 SAE 特征：用 SAE 验证模型是否真正遵循宪法原则（特征级证据，而非行为级推断）
...
- [[AI/3-LLM/RL/实践/RLHF-工程全栈|RLHF 全链路]] — RLHF 完整流程（SFT + RM + PPO）
- AI 安全与对齐 2026 技术全景 — 大全景版，覆盖红队/鲁棒性/Scalable Oversight
...
## See Also
- [[AI/5-AI 安全/安全对齐与红队|安全对齐与红队]] — Jailbreak 分类 + 红队测试流程（攻防实践视角）
- [[AI/5-AI 安全/AI 安全及隐私保护|AI 安全及隐私保护]] — 训练/推理/部署三阶段威胁全景
