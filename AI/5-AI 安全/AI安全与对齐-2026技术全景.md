...
related:
  - "[[对齐技术总结|对齐技术总结]]"
  - "[[RLHF-DPO-2026-技术全景|RLHF-DPO 技术全景]]"
...
### 脑暴：如果往下延伸
- 将 [[对齐技术总结|对齐技术总结]] 中的 DPO 变体与 RepE 结合，能否设计一个"自适应对齐强度"系统——对安全敏感查询自动增强对齐，对普通查询降低对齐税？
- SAE 特征发现 + [[幻觉问题|幻觉问题]] 中的 SelfCheckGPT 结合：能否通过检测"幻觉特征"的激活模式实现 real-time 幻觉阻断（类似 Circuit Breakers for Hallucination）？
...
-  — AI 安全全景索引
- [[安全对齐与红队|安全对齐与红队]] — Jailbreak 攻防详解
- [[Adaptive-Regularization-Safety-Degradation-Finetuning|Adaptive-Regularization]] — 2026 最新：harmful intent 在 hidden state 中线性可分（AUROC>0.9）
- [[对齐技术总结|对齐技术总结]] — RLHF/DPO/宪法 AI 技术路线对比
- [[RLRR-Reference-Guided-Alignment-Non-Verifiable|RLRR]] — 非可验证任务的对齐新范式
