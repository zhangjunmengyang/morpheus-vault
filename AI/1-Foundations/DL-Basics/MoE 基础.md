...
![image](EGPIdd2fioDR3ZxtjSmcyDTfnwf.png)
...
![image](Clybd8mwdo2Szuxi8GHcocoinGb.png)
...
1. 添加一些噪声
1. 选择保留前 K 个值
![image](KTfZdOjJxosVBDxaDa2cSoCOnXd.png)
...
![image](N1vadJ3XVoAHC3xIgIBcJUOKnTg.png)
...
![image](Kqykd3bPSoFpK3xBJEgcKh7Hnmh.png)
...
![image](BWzfdRQTkonCugxfSwJcq7ctnag.png)

**通过仅冻结 MoE 层，我们可以在保持质量的同时加快训练速度。该图来自 ST-MoE 论文。**

学习率 & batch size：

![image](AMLodIqkYovPknxr8thch81lnHd.png)
