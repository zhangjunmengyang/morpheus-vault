...
- [[Layer Normalization|Layer Normalization]] — Pre-Norm / RMSNorm 在 Transformer 中的关键角色
- [[线性代数|线性代数]] — QKV 矩阵乘法、注意力分数计算的数学基础
- [[Attention 变体综述|Attention 变体综述]] — 从标准 MHA 到 MQA/GQA/FlashAttention 的演化
