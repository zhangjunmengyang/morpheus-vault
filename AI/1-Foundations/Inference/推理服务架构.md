...
> [!info] 📖 版本说明
> 本篇为**面试速查版**（简洁直接）。深度工程版：[[AI/3-LLM/Inference/推理服务架构|推理服务架构工程深度版]]
...
- [[AI/3-LLM/Inference/推理服务架构|推理服务架构（LLM 深度版）]] — 本文面试版，深度版含 vLLM/TensorRT-LLM/生产部署完整方案
- [[AI/1-Foundations/Inference/KV Cache|KV Cache]] — 推理服务架构的核心内存管理机制；PagedAttention/Continuous Batching 都是围绕 KV Cache 的架构创新
- [[AI/3-LLM/Inference/LLM推理优化2026全景|LLM 推理优化 2026 全景]] ⭐ — 推理服务工程全景；本文提供概念框架，全景版提供2026年工业界最新实践
- [[Jet-RL-FP8-On-Policy-RL-Training|Jet-RL（FP8 On-Policy RL）]] — FP8 推理在 RL 训练场景的应用；同样的 FP8 精度在推理服务和 RL 训练中的工程挑战不同
