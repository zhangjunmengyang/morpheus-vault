...
> [!info] 📖 版本说明
> 本篇为**面试速查版**（简洁直接）。深度工程版：[[量化综述|量化技术工程深度版]]
...
- [[模型剪枝与知识蒸馏|模型剪枝与知识蒸馏]] — 与量化并列的压缩手段
- [[端侧推理量化精度陷阱-跨骁龙芯片精度失真|端侧量化精度陷阱]] — 量化在实际部署中的精度失真问题
- [[Jet-RL-FP8-On-Policy-RL-Training|Jet-RL FP8]] — FP8 量化在 RL 训练中的应用
