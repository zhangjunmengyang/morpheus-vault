...
- [[AI/1-Foundations/Training/Scaling Laws|Scaling Laws]] — loss 曲线宏观规律：参数量/数据量/计算量的幂律
- [[向量微积分|向量微积分]] — 梯度下降、反向传播的数学基础
- [[verl 概述|verl 框架]] — 分布式 RL 训练中的 loss 监控
- [[AI/1-Foundations/目录|Foundations MOC]] — 训练基础全图谱
