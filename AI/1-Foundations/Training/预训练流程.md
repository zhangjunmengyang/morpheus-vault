...
- [[AI/1-Foundations/Training/Scaling Laws|Scaling Laws]] — 预训练的核心决策依据：模型/数据/计算的最优配比
- [[AI/3-LLM/Pretraining/LLM预训练与分布式训练2026全景|LLM 预训练 2026 全景]] — 工程全景：分布式训练/数据工程/优化技巧（2183行深度版）
- [[Training Loss 分析|Training Loss 分析]] — 预训练过程中 loss 曲线的解读
