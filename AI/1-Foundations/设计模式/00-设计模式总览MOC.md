...
### 创建型
- [[AI/1-Foundations/设计模式/01-创建型模式]] — 工厂 / 建造者 / 单例 / 原型

### 结构型
- [[AI/1-Foundations/设计模式/02-结构型模式]] — 适配器 / 装饰器 / 代理 / 外观 / 组合

### 行为型（GoF）
- [[AI/1-Foundations/设计模式/03-行为型模式-GoF]] — 观察者 / 策略 / 责任链 / 状态 / 命令 / 中介者

### 架构 & AI 协作模式
- [[AI/1-Foundations/设计模式/04-架构模式与AI协作]] — 管道 / 黑板 / 发布订阅 / 监督者 / 蜂群
...
详见 → [[AI/1-Foundations/设计模式/04-架构模式与AI协作]]
