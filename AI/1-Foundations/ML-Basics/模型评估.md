---
brief: "模型评估——Accuracy/Precision/Recall/F1/AUC-ROC 的计算和适用场景；LLM 专用评估：PPL/BLEU/ROUGE/BERTScore；验证集设计/数据泄露防御/benchmark 污染的工程注意事项。"
title: "模型评估"
type: concept
...
![image](OQYQdKY21oMwjAxVXCMc2fW6nOS.png)
...
![image](BSpGdgWeHoexeexExAnca42fnZf.png)
...
![image](MoScd4huSowVmkxNb45cWtuWnBf.png)
...
![image](BIHkdMkS7oIBAjxx7lncligfn5c.png)
...
- [[AI/3-LLM/Evaluation/LLM 评测体系|LLM 评测体系]] — 从经典 ML 评估到 LLM benchmark 的演化
- [[AI/1-Foundations/ML-Basics/数据预处理|数据预处理]] — 数据质量对评估指标的影响
- [[AI/1-Foundations/ML-Basics/过拟合欠拟合|过拟合欠拟合]] — 评估中的过拟合诊断
-  — ML 基础全图谱
