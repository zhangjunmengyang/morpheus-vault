---
brief: "机器学习系统课程入口——西湖大学/Karpathy/Fast.ai 等主流 ML 课程的学习资料汇总；从监督学习到神经网络的基础知识地图；是入门 LLM 的必要数学和 ML 前置知识体系。"
title: "机器学习"
type: tutorial
...
- [[AI/1-Foundations/ML-Basics/机器学习-知识点|机器学习知识点]] — 面试速查配套：本文核心算法的面试高频考点整理
