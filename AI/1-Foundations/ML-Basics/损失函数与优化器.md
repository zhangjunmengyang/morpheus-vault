...
对比学习的核心 loss，用于 Embedding 模型与向量数据库（）的训练：
...
详见 [[AI/3-LLM/RL/实践/对齐技术综述|对齐技术综述]]，这里给出实现和梯度分析：
...
-  — 数学基础全图谱
- [[AI/3-LLM/RL/实践/对齐技术综述|对齐技术综述]] — DPO Loss 的对齐应用背景
- SFT MOC — Cross-Entropy Loss 在 SFT 中的核心角色
- [[AI/3-LLM/RL/Theory/GRPO-改进七维框架分析|GRPO 改进全景 2026]] — Trust Region / 优化器选择与 RL 训练稳定性
