...
- [[AI/1-Foundations/ML-Basics/GELU|GELU]] — GELU 激活函数详解，LLM 标配：高斯误差线性单元，smooth 版 ReLU
- [[AI/1-Foundations/ML-Basics/SwiGLU|SwiGLU]] — 进化版激活函数：SwiGLU = Swish 门控 × 线性变换，LLaMA/PaLM/Gemini 标配 FFN 设计
- [[AI/1-Foundations/ML-Basics/损失函数|损失函数]] — 激活函数与 loss 的关系（Sigmoid + BCE）
- [[AI/1-Foundations/DL-Basics/Layer Normalization|Layer Normalization]] — FFN 另一核心组件：归一化层与激活函数共同构成 Transformer FFN
