---
brief: "学习率调度——学习率对训练稳定性和收敛速度的影响；Warmup+Cosine Decay/Linear Decay/Constant 的对比；LLM 训练中 warmup 步数选择的经验规则；AdamW 学习率与 batch size 的 Linear Scaling Rule。"
title: "学习率"
type: tutorial
...
![image](NA2rdklTxo0ZJvxGxcXcLjrEnRb.png)
...
- [[Training Loss 分析|Training Loss 分析]] — 学习率对 loss 曲线的直接影响
- [[AI/1-Foundations/Training/Scaling Laws|Scaling Laws]] — μP 等学习率 scaling 方法
- [[AI/1-Foundations/ML-Basics/损失函数|损失函数]] — loss landscape 的几何直觉与学习率选择
-  — ML 基础全图谱
