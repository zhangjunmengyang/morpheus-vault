---
brief: "数据预处理——文本数据的清洗/去重/格式标准化；tokenization 前的数据处理 SOP；数据质量对 LLM 训练效果的影响（质量 > 数量）；大规模预训练数据工程的基础知识。"
title: "数据预处理"
type: concept
...
- [[AI/1-Foundations/ML-Basics/特征工程|特征工程]] — 数据预处理的下游：特征变换与选择
- [[AI/1-Foundations/ML-Basics/模型评估|模型评估]] — 预处理质量对评估结果的影响
-  — ML 基础全图谱
