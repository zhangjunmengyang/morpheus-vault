...
- **代码库搜索与理解**：对代码仓库建向量索引，支持自然语言查找代码片段和函数（参见 [[AI/LLM/Application/LLM代码生成-2026技术全景|代码生成全景]]）
...
- 结合 [[AI/LLM/Application/LLM代码生成-2026技术全景|代码生成]] 的 RAG over Codebase，是 Cursor/Claude Code 的核心技术栈
