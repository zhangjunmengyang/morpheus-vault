...
- [[AI/Agent/Evaluation/CowCorpus-Human-Intervention-Modeling-Web-Agents|CowCorpus]] — 人类干预时机建模；OMNI-LEAK 的 Notification Agent 无限制 send 问题正是 CowCorpus 干预节点能阻断的典型场景
