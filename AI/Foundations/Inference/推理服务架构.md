...
- [[AI/LLM/RL/Frameworks/Jet-RL-FP8-On-Policy-RL-Training|Jet-RL（FP8 On-Policy RL）]] — FP8 推理在 RL 训练场景的应用；同样的 FP8 精度在推理服务和 RL 训练中的工程挑战不同
