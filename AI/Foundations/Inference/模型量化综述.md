---
brief: "模型量化综述——PTQ（训练后量化）vs QAT（量化感知训练）；INT8/INT4/NF4/FP8 精度格式对比；GPTQ/AWQ/SmoothQuant 算法原理；量化对 LLM 困惑度的影响规律；面试被问推理部署如何降本必答。"
title: "LLM 模型量化综述"
date: 2026-02-14
...
> [!info] 📖 版本说明
> 本篇为**面试速查版**（简洁直接）。深度工程版：[[AI/LLM/Inference/量化综述|量化技术工程深度版]]
...
- [[AI/Foundations/Inference/模型剪枝与知识蒸馏|模型剪枝与知识蒸馏]] — 与量化并列的压缩手段
- [[AI/LLM/Inference/端侧推理量化精度陷阱-跨骁龙芯片精度失真|端侧量化精度陷阱]] — 量化在实际部署中的精度失真问题
- [[AI/LLM/Frameworks/Jet-RL-FP8-On-Policy-RL-Training|Jet-RL FP8]] — FP8 量化在 RL 训练中的应用
- [[AI/Foundations/目录|Foundations MOC]] — 推理优化基础全图谱
