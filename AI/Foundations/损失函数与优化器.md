...
对比学习的核心 loss，用于 Embedding 模型与向量数据库（[[AI/RAG/_MOC|参见 RAG MOC]]）的训练：
...
详见 [[AI/LLM/RL/对齐技术综述|对齐技术综述]]，这里给出实现和梯度分析：
...
- [[AI/LLM/RL/对齐技术综述|对齐技术综述]] — DPO Loss 的对齐应用背景
- [[AI/LLM/SFT/_MOC|SFT MOC]] — Cross-Entropy Loss 在 SFT 中的核心角色
- [[AI/LLM/RL/Theory/GRPO-Improvement-Panorama-2026|GRPO 改进全景 2026]] — Trust Region / 优化器选择与 RL 训练稳定性
