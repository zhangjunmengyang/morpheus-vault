...
- [[AI/Foundations/ML-Basics/模型评估|模型评估]] — 过拟合诊断的评估方法
- [[AI/Foundations/Training/PEFT 参数高效微调|PEFT 参数高效微调]] — LoRA 等 PEFT 方法本质上是正则化策略
- [[AI/Foundations/Training/Scaling Laws|Scaling Laws]] — 规模 vs 过拟合：为什么大模型反直觉地不过拟合
