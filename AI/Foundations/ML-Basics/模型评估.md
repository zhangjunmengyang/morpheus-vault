...
- [[AI/LLM/Evaluation/LLM 评测体系|LLM 评测体系]] — 从经典 ML 评估到 LLM benchmark 的演化
- [[AI/Foundations/ML-Basics/数据预处理|数据预处理]] — 数据质量对评估指标的影响
- [[AI/Foundations/ML-Basics/过拟合欠拟合|过拟合欠拟合]] — 评估中的过拟合诊断
