...
- [[AI/Foundations/ML-Basics/GELU|GELU]] — GELU 激活函数详解，LLM 标配
- [[AI/Foundations/DL-Basics/Transformer|Transformer 通识]] — 激活函数在 FFN 层的作用
- [[AI/Foundations/ML-Basics/损失函数|损失函数]] — 激活函数与 loss 的关系（Sigmoid + BCE）
