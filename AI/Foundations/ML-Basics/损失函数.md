---
brief: "损失函数——CrossEntropyLoss/InfoNCE/DPO Loss/KL 散度的数学推导和应用场景；LLM 训练（CE Loss）vs 对齐（DPO Loss）vs 对比学习（InfoNCE）的损失函数选型；ignore_index 的实现细节。"
title: "损失函数"
type: concept
...
- [[AI/Foundations/ML-Basics/学习率|学习率]] — 损失函数梯度 + 学习率 = 参数更新
- [[AI/Foundations/ML-Basics/PPL 困惑度|PPL 困惑度]] — 语言模型专用 loss：交叉熵的 exp
- [[AI/LLM/RL/Fundamentals/强化学习的数学原理|强化学习数学原理]] — RL reward 与 loss 的关系
