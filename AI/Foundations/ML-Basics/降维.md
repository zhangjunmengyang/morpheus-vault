...
![image](assets/IUPed6A9noZ4wGxSPMMcQ3bin8d.png)
...
- [[AI/Foundations/Math/线性代数|线性代数]] — SVD/PCA 的数学基础
- [[AI/Foundations/ML-Basics/特征工程|特征工程]] — 降维是特征工程的关键环节
- [[AI/Foundations/ML-Basics/数据预处理|数据预处理]] — 降维前的数据准备
