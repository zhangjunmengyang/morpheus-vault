...
related:
  ...
  - "[[Projects/MA-RLHF/lc3/lc3-01-GPT2-手撕实操]]"
  - "lc5-DeepSeek-V3-MOC"
---
...
- [[Projects/MA-RLHF/lc4/lc4-06-GQA-KVCache-手撕实操]] — Batch D 同批次：KV Cache 完整推理实现（GQA + 增量解码）
- [[Projects/MA-RLHF/xtrain/xtrain-03b-ZeRO-手撕实操]] — ZeRO 分片与 Adam 工程实现（Muon 的对比基准）
- [[Projects/MA-RLHF/lc5/lc5-02-DeepSeek-MLA-手撕实操]] — MLA 架构（GLM-5 Muon Split 为解决 MLA+Muon 不兼容而设计）
- [[Projects/MA-RLHF/lc3/lc3-01-GPT2-手撕实操]] — GPT-2 完整训练流程（GPT Loss 的应用场景）
- lc5-DeepSeek-V3-MOC — lc5 DeepSeek V3 课程地图（Muon 在架构创新中的位置）
