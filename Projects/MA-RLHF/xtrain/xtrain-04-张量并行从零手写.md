...
- **前置**：[[Projects/MA-RLHF/xtrain/xtrain-03b-ZeRO-手撕实操]] — ZeRO 切存储 vs TP 切计算
- **前置**：`autograd.Function` 基础（`custom_gradient.py`）
- **后置**：[[Projects/MA-RLHF/xtrain/xtrain-05b-Pipeline-Parallel-手撕实操]] — PP 在层间切分，TP + PP = 混合并行
- **横向**：[[Projects/MA-RLHF/xtrain/xtrain-04b-Tensor-Parallel-手撕实操]] — 更早的 TP 原理笔记
...
- [[Projects/MA-RLHF/xtrain/xtrain-03b-ZeRO-手撕实操]] — 前置：ZeRO 切存储 vs TP 切计算，根本差异对比
- [[Projects/MA-RLHF/xtrain/xtrain-05b-Pipeline-Parallel-手撕实操]] — 后置：PP 层间切分，TP+PP=混合并行
- [[Projects/MA-RLHF/xtrain/xtrain-04b-Tensor-Parallel-手撕实操]] — 横向：更早的 TP 原理版，算法视角
