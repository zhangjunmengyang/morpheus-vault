...
related:
  ...
  - "[[Projects/MA-RLHF/lc9/lc9-ray-01-Ray-分布式RL训练实操|Ray-分布式RL训练实操]]"
---
...
**分布式训练四维并行谱系**
- [[Projects/MA-RLHF/lc-comm/lc-comm-01-分布式训练通信原语-手撕实操|分布式训练通信原语手撕]] — ZeRO 的底层：AllReduce/ReduceScatter/AllGather 的 ring 实现
- [[Projects/MA-RLHF/xtrain/xtrain-04b-Tensor-Parallel-手撕实操|Tensor-Parallel-手撕实操]] — TP（列/行切分 Linear，通信模式与 ZeRO 正交）
- [[Projects/MA-RLHF/xtrain/xtrain-05b-Pipeline-Parallel-手撕实操|Pipeline-Parallel-手撕实操]] — PP（层间切分，与 ZeRO-3 可叠加）
- [[Projects/MA-RLHF/lc9/lc9-ray-01-Ray-分布式RL训练实操|Ray-分布式RL训练实操]] — verl 工程实践层（ZeRO 作为 actor 后端）

**理论对应**
- [[AI/3-LLM/Frameworks/verl/训练后端|verl 训练后端]] — ZeRO（FSDP）在 verl 中的工程集成
- [[Projects/MA-RLHF/MA-RLHF-手撕实操-系列索引|MA-RLHF 手撕实操系列索引]] — ZeRO 在整个课程中的位置（lc9 分布式RL训练）
