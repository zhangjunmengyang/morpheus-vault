...
related:
  ...
  - "[[Projects/MA-RLHF/xtrain/xtrain-07b-MoE-Context-Parallel-手撕实操]]"
  - "[[Projects/MA-RLHF/MA-RLHF-手撕实操-系列索引]]"
  - "[[Projects/MA-RLHF/lc10/lc10-00-FlashAttention-手撕实操]]"
---
...
- **前置**：[[Projects/MA-RLHF/lc10/lc10-03-vLLM-PageAttention-手撕实操]] — Online Softmax 三元组 (O,M,L) 的 inference 应用
- **前置**：[[Projects/MA-RLHF/lc10/lc10-00-FlashAttention-手撕实操]] — FA 是 Ring Attention 的单卡版
- **前置**：[[Projects/MA-RLHF/xtrain/xtrain-05b-Pipeline-Parallel-手撕实操]] — PP 是层间切分，CP 是序列维度切分
...
- [[Projects/MA-RLHF/xtrain/xtrain-05b-Pipeline-Parallel-手撕实操]] — 前置：PP 层间切分，CP+PP 超长序列训练的两维度
- [[Projects/MA-RLHF/xtrain/xtrain-04b-Tensor-Parallel-手撕实操]] — 前置：TP 与 CP 正交可组合（TP 切权重，CP 切序列）
- [[Projects/MA-RLHF/lc10/lc10-00-FlashAttention-手撕实操]] — FA 是 Ring Attention 的单卡版，Online Softmax 同源
- [[Projects/MA-RLHF/lc10/lc10-03-vLLM-PageAttention-手撕实操]] — Online Softmax (O,M,L) 三元组在推理端的应用
