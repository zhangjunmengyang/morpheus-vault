...
- **前置**：[[Projects/MA-RLHF/xtrain/xtrain-04b-Tensor-Parallel-手撕实操]] — TP 和 PP 是两个维度的并行
- **前置**：[[Projects/MA-RLHF/xtrain/xtrain-03b-ZeRO-手撕实操]] — ZeRO + PP 减少每个 stage 的显存
...
- [[Projects/MA-RLHF/xtrain/xtrain-04b-Tensor-Parallel-手撕实操]] — 前置：TP 层内并行，与 PP 层间切分正交可组合
- [[Projects/MA-RLHF/xtrain/xtrain-03b-ZeRO-手撕实操]] — 前置：ZeRO+PP 减少每 stage 显存
- [[Projects/MA-RLHF/xtrain/xtrain-06-Context并行RingAttention手写]] — 后置：CP 序列维度切分，PP+CP 超长序列训练
- [[Projects/MA-RLHF/xtrain/xtrain-07b-MoE-Context-Parallel-手撕实操]] — DualPipe 设计动机正是 MoE EP 通信重叠
