...
tags:
  ...
  - lc8
related:
  - "[[Projects/MA-RLHF/lc8-PPO/lc8-05-LLaMA2-Reward-Model实现]]"
...
- [[Projects/MA-RLHF/lc8-PPO/lc8-05-LLaMA2-Reward-Model实现]] — 同内容 Batch A 版
- [[Projects/MA-RLHF/lc8-PPO/lc8-03-RLHF-PPO-完整Pytorch实现]] — 同系列：PPO 四模型完整训练
- [[Projects/MA-RLHF/lc8-DPO/lc8-04-DPO-BT-偏好优化手撕实操]] — 同系列：BT 模型理论基础
- [[AI/3-LLM/RL/算法/PPO 原理]] — PPO 算法理论（RM 是 RLHF 的前置模块）
