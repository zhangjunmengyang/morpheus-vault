...
related:
  - "[[AI/3-LLM/SFT/LoRA]]"
  - "[[Projects/MA-RLHF/lc6/lc6-01-SFT-手撕实操]]"
  - "[[Projects/MA-RLHF/lc5/lc5-02-DeepSeek-MLA-手撕实操]]"
  - "[[Projects/MA-RLHF/lc3/lc3-03-GPTLoss-Muon优化器手撕实操]]"
  - "[[AI/3-LLM/SFT/SFT-实战指南]]"
---
...
- [[AI/3-LLM/SFT/LoRA]] — LoRA 理论精读（本笔记的代码实现对应的理论背景，含 rank 选择实验）
- [[Projects/MA-RLHF/lc6/lc6-01-SFT-手撕实操]] — SFT 手撕实操（LoRA 在 SFT 流程中的完整应用）
- [[Projects/MA-RLHF/lc5/lc5-02-DeepSeek-MLA-手撕实操]] — MLA 的低秩 KV 压缩（同一低秩分解思路在 Attention 上的应用）
- [[Projects/MA-RLHF/lc3/lc3-03-GPTLoss-Muon优化器手撕实操]] — Muon 梯度正交化（低秩梯度的另一种工程利用）
- [[Projects/MA-RLHF/xtrain/xtrain-03b-ZeRO-手撕实操]] — ZeRO 显存优化（LoRA + ZeRO 组合是常见的显存节省方案）
