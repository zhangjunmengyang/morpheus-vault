...
related:
  ...
  - "[[Projects/MA-RLHF/lc4/lc4-06-GQA-KVCache-手撕实操]]"
...
详见 [[Projects/MA-RLHF/lc4/lc4-04-TPA-YaRN-RoPE外推手撕实操]]。
...
- [[Projects/MA-RLHF/lc4/lc4-04-TPA-YaRN-RoPE外推手撕实操]] — YaRN 完整代码实现 + TPA 张量积注意力（本笔记理论 → 该笔记工程实现）
- [[Projects/MA-RLHF/lc5/lc5-02-DeepSeek-MLA-手撕实操]] — MLA 中 RoPE 解耦（低秩 KV + position 单独路径，RoPE 应用的最新工程形态）
- [[Projects/MA-RLHF/xtrain/xtrain-04b-Tensor-Parallel-手撕实操]] — TP 下 RoPE 的实现考虑（各卡独立旋转，分布式场景）
- [[Projects/MA-RLHF/lc4/lc4-06-GQA-KVCache-手撕实操]] — KV Cache 中 RoPE 的位置追踪（增量解码时 position_ids 的正确维护）
