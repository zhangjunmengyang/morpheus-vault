...
- [[Projects/MA-RLHF/lc8-KTO/lc8-02-KTO-完整Notebook实现|KTO 完整 Notebook 实现]] — 端到端完整实现（前景理论偏好建模 + loss asymmetry + z_ref 参考期望），与本文互补：本文讲核心原理，Notebook 讲完整训练流程
- [[Projects/MA-RLHF/lc8-DPO/lc8-01-DPO-手撕实操|DPO 手撕实操]] — KTO 的前置算法：理解 BT 偏好模型和 DPO loss 后再看 KTO 的数据效率优势更清晰
- [[Projects/MA-RLHF/lc8-DPO/lc8-03-DPO-完整Notebook实现|DPO 完整 Notebook 实现]] — 与 KTO-Notebook 对比：DPO 需要 paired data vs KTO 只需单条 + 标签
- lc8 RL×LLM 专题地图 — 课程 MOC 入口，KTO 在偏好优化章节（Step 4）
...
- RLHF-DPO 2026 技术全景 — 偏好优化算法谱系（含 KTO 与 DPO/IPO/SimPO 的系统对比）
