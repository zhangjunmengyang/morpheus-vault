...
tags:
  ...
  - lc8
related:
  - "[[Projects/MA-RLHF/lc8-KTO/lc8-01-KTO-手撕实操]]"
  - "[[Projects/MA-RLHF/lc8-KTO/lc8-02-KTO-完整Notebook实现]]"
  - "[[Projects/MA-RLHF/lc8-PPO/lc8-07-PRM-O1-Search-手撕实操]]"
  - "lc8-RL×LLM-MOC"
  - "RLHF-DPO-2026-技术全景"
---
...
- [[Projects/MA-RLHF/lc8-KTO/lc8-01-KTO-手撕实操]] — 同算法手撕实操版（MA-RLHF lc8 Batch A）
- [[Projects/MA-RLHF/lc8-KTO/lc8-02-KTO-完整Notebook实现]] — 同算法 Notebook 端到端版
- [[Projects/MA-RLHF/lc8-PPO/lc8-07-PRM-O1-Search-手撕实操]] — PRM 搜索 Batch A 版
- [[Projects/MA-RLHF/lc8-DPO/lc8-04-DPO-BT-偏好优化手撕实操]] — 同系列：DPO/IPO 实现
