...
![image](assets/GF4LddQkso9JogxyqOPcceIgnof.png)
...
![image](assets/ZrJDdBtFmocXW7xHUM6cClYdnAh.png)

*表示执行的动作序列*

![image](assets/ZQkndAADPo5STHxLSaWcm987ngb.png)

*表示相应的中间状态序列。该函数评估状态转换是否满足任务 T 设定的标准。*

## 2.2、方法

![image](assets/JHQYd3ZiSoGZSwxw9wzc60uwnKe.png)
